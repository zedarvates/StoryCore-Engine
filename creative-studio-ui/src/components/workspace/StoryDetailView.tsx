        ...
        <div className="story-detail-content">
          ...
          <div className="story-detail-title-section">
            ...
            <div className="story-detail-metadata-grid">
              ...
              {new Date(story.updatedAt).getTime() !== new Date(story.createdAt).getTime() && (
                <div className="metadata-item">
                  <Calendar className="w-4 h-4" />
                  <div>
          ...
          {/* Characters Used */}
          {(story.charactersUsed?.length || 0) > 0 && (
            <div className="story-detail-section">
              <h2 className="section-title">
              ...
              <div className="characters-grid">
                {story.charactersUsed.map((character, index) => (
                  <div key={`${character.id}-${index}`} className="character-item">
          ...
          {/* Locations Used */}
          {(story.locationsUsed?.length || 0) > 0 && (
            <div className="story-detail-section">
              <h2 className="section-title">
              ...
              <div className="locations-grid">
                {story.locationsUsed.map((location, index) => (
          ...
          {(story.autoGeneratedElements?.length || 0) > 0 && (
            <div className="story-detail-section">
              <h2 className="section-title">
              ...
              <div className="auto-generated-list">
                {story.autoGeneratedElements.map((element, index) => (
                  <div key={`${element.id}-${index}`} className="auto-generated-item">
