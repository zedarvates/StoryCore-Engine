...
export type IntentName = 
  ...
  | 'CONTEXT_ANALYSIS' | 'WORKFLOW_SUGGESTION' | 'BATCH_OPERATION' | 'PLUGIN_ACTION'
  | 'NONE';
...
export class IntentOrchestrationService {
  ...
  - SYSTEM: UNDO, REDO, OPEN_SETTINGS, TOGGLE_AUTOSAVE, SHOW_STATUS
  - ADVANCED: CONTEXT_ANALYSIS, WORKFLOW_SUGGESTION, BATCH_OPERATION, PLUGIN_ACTION
