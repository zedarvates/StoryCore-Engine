...
├── reports/                           # Progress reports directory
├── .kiro/specs/                       # Specifications directory
└── ... (other directories like src/, tests/, etc.)
```
...
```
reports/
├── AI_ENHANCEMENT_FINAL_COMPLETION_REPORT.md  # AI enhancement completion
├── COMFYUI_INTEGRATION_COMPLETE.md            # ComfyUI integration summary
├── MVP_COMPLETION_SUMMARY.md                  # MVP completion report
├── TASK_A2_A3_COMPLETION_SUMMARY.md           # Task completion summaries
└── ... (numerous progress and completion reports)
```

## Plans Directory
```
plans/
├── DAY_2_EXECUTION_PLAN.md                    # Execution plans
├── PLAN_JOURS_4_7_AI_ENHANCEMENT.md           # Enhancement plans
├── AUDIT_REMEDIATION_PLAN.md                  # Remediation plans
...
```
.kiro/specs/
├── ai-enhancement/                            # AI enhancement specifications
│   ├── design.md                              # Design specs
│   ├── requirements.md                        # Requirements
│   └── tasks.md                               # Task breakdown
├── video-engine/                              # Video engine specs
│   ├── design.md
│   ├── requirements.md
│   └── tasks.md
...
## Workflow and Configuration Directories
```
workflows/                             # ComfyUI workflow definitions
config/                                # Configuration files
data/                                  # Data manifests and metadata
```
...
To maintain a clear and organized project structure, follow these guidelines when creating new files:

- **`docs/`**: Place guides, READMEs, tutorials, and general documentation (.md files)
- **`plans/`**: Place planning documents, execution plans, and strategic roadmaps (.md files)
- **`reports/`**: Place progress summaries, completion reports, and status updates (.md files)
- **`.kiro/specs/`**: Place specifications, design docs, requirements, and task breakdowns (.md files)
- **`src/`**: Source code files (.py, .js, etc.)
- **`tests/`**: Test files
- **`assets/`**: Static assets
- **`workflows/`**: ComfyUI workflow definitions (.json files)
- **`config/`**: Configuration files (.json files)
- **`data/`**: Data manifests and metadata (.json files)
- **`examples/`**: Example files (.json files)

This organization ensures that documentation is easy to find and maintain.
