...
class AIMusicRemixService:
    ...
    def detect_music_sections(self, audio_path: str) -> List[Dict[str, Any]]:
        """
    ...
    def remix_music(self, config: MusicRemixConfig) -> Tuple[bool, str]:
        """
    ...
    def _remix_loop(
        self, config: MusicRemixConfig, current_duration: float
    ) -> Tuple[bool, str]:
    ...
    def _remix_cut(
        ...
        try:
            ...
            # Calculate cut point
            current_duration - intro_duration - outro_duration
            needed_from_middle = (
                config.target_duration - intro_duration - outro_duration
            )
            ...
            if needed_from_middle <= 0:
                ...
                cmd = [
                    ...
                    config.input_path,
                    "-af",
                    f"atrim=0:{intro_duration},atrim=0:{needed_from_middle},atrim=-{outro_duration}",
                    "-c:a",
                    "aac",
                    "-b:a",
                    "192k",
        ...
        try:
            ...
            if target > current_duration:
                ...
                cmd = [
                    ...
                    str(new_duration),
                    "-af",
                    "afade=t=out:st={}:d=2".format(new_duration - 2),
                    "-c:a",
                    "aac",
                    "-b:a",
                    "192k",
...
def create_animation_presets_service(
    ffmpeg_path: str = "ffmpeg",
) -> AnimationPresetsService:
    return AnimationPresetsService(ffmpeg_path)


def create_pose_interpolation_service(
    ffmpeg_path: str = "ffmpeg",
) -> AIPoseInterpolationService:
