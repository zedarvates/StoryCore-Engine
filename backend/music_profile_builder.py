...
class MusicProfile:
    ...
    instrument_constraints: Dict[str, bool] = field(
...
class MusicProfileBuilder:
    ...
    def set_action(
        self, action_type: str, intensity: str, visual_rhythm: str
    ) -> "MusicProfileBuilder":
    ...
    def add_instrument_constraint(
        self, instrument: str, allowed: bool = True
    ) -> "MusicProfileBuilder":
    ...
    def build(self) -> MusicProfile:
        ...
        logger.info(
            f"MusicProfile {profile.id} built successfully with {len(tracks)} tracks"
        )
        return profile
    ...
    def _build_tracks(
        self, action_context: Optional[ActionContext]
    ) -> List[MusicTrack]:
    ...
    def _to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "themes": self._themes,
            "visual_style": self._visual_style,
            "emotional_intensity": self._emotional_intensity.value
            if self._emotional_intensity
            else None,
            "action_type": self._action_type.value if self._action_type else None,
            "action_intensity": self._action_intensity.value
            if self._action_intensity
            else None,
