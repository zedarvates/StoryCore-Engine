...
def test_invalid_report_wrong_type():
    ...
    payload = {
        ...
        "user_input": {"description": "This is a test report with invalid type"},
    }
...
def test_with_full_diagnostics():
    ...
    payload = {
        ...
        "module_context": {
            ...
            "module_state": {"current_panel": 7, "total_panels": 9, "qa_score": 85.5},
        },
        "user_input": {
        ...
        "diagnostics": {
            ...
            "process_state": {"cpu_percent": 78.3, "threads": 12, "open_files": 45},
        },
        "screenshot_base64": None,
    }
