...
async def generate_character(
    ...
    try:
        ...
        char_data = {
            ...
            "role": role,
            "personality": traits,
            "dialogue_style": f"Professional and {traits[0].value}" if traits else "Standard"
        }
        ...
        character.background = await character_service.generate_character_backstory(character, request.genre)
