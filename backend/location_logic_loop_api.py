...
from backend.story_transformer import generate_logic_loop_location, LocationFunction
...
class LogicLoopGenerationRequest(BaseModel):
    ...
    description: str = Field(
        ..., min_length=10, description="Basic description of the location"
    )
    genre: str = Field(
        default="fantasy", description="Story genre (fantasy, sci-fi, etc.)"
    )
    tone: str = Field(default="serious", description="Tone (dark, light, epic, etc.)")
    function: Optional[LocationFunctionType] = Field(
        default=None, description="Primary function (auto-detected if not provided)"
    )
    context: Optional[str] = Field(
        default=None, description="Additional world-building context"
    )
...
class LogicLoopEnhancementRequest(BaseModel):
    ...
    function: Optional[LocationFunctionType] = Field(
        default=None, description="Primary function"
    )
...
def format_reputation_for_prompt(reputation: dict) -> str:
    ...
    return (
        "\n".join(parts)
        if parts
        else "Reputation emerging from function and constraints"
    )
...
def format_emergent_details_for_prompt(details: dict) -> str:
    ...
    return (
        "\n".join(parts)
        if parts
        else "Details emerging from function, constraints, and culture"
    )
...
async def generate_location_logic_loop(
    request: LogicLoopGenerationRequest, user_id: str = Depends(verify_jwt_token)
    ...
    """
    logger.info(
        f"Generating Location Logic Loop for '{request.name}' (user: {user_id})"
    )
...
async def get_location_logic_loop(
    location_id: str, user_id: str = Depends(verify_jwt_token)
) -> Dict[str, Any]:
    """
                ...
                "sub_functions": [
                    {
                        "id": "trade_hub",
                        "name": "Trade Hub",
                        "description": "Crossroads of commerce",
                    },
                    {
                        "id": "mining",
                        "name": "Mining",
                    ...
                    },
                    {
                        "id": "fishing",
                        "name": "Fishing",
                        "description": "Maritime resources",
                    },
                    {
                        "id": "agricultural",
                        "name": "Agricultural",
                        "description": "Farming region",
                    },
                    {
                        "id": "manufacturing",
                        "name": "Manufacturing",
                ...
                "sub_functions": [
                    {
                        "id": "fortress",
                        "name": "Fortress",
                        "description": "Impregnable stronghold",
                    },
                    {
                        "id": "border_post",
                        "name": "Border Post",
                        "description": "Frontier garrison",
                    },
                    {
                        "id": "watchtower",
                        "name": "Watchtower",
                        "description": "Surveillance outpost",
                    },
                    {
                        "id": "sanctuary",
                        "name": "Sanctuary",
                        "description": "Protected refuge",
                    },
                ],
            },
            {
                ...
                "sub_functions": [
                    ...
                    },
                    {
                        "id": "resistance",
                        "name": "Resistance",
                        "description": "Underground headquarters",
                    },
                    {
                        "id": "royal_court",
                        "name": "Royal Court",
                        "description": "Political center",
                    },
                ],
            },
            {
                ...
                "sub_functions": [
                    {
                        "id": "waystation",
                        "name": "Way Station",
                        "description": "Army resupply",
                    },
                    {
                        "id": "space_station",
                        "name": "Space Station",
                        "description": "Space refueling",
                    },
                    {
                        "id": "caravan_stop",
                        "name": "Caravan Stop",
                        "description": "Trade route rest point",
                    },
                    {
                        "id": "communication",
        ...
        "constraint_types": [
            {
                "id": "environmental",
                "name": "Environmental",
                "examples": ["Weather", "Terrain", "Natural disasters"],
            },
            {
                "id": "resource_scarcity",
                "name": "Resource Scarcity",
                "examples": ["No timber", "No water", "No food"],
            },
            {
                "id": "external_threat",
                "name": "External Threats",
                "examples": ["Enemies", "Monsters", "Rivals"],
            },
        ],
    }
            ...
            "mining": [
                {
                    "type": "environmental",
                    "severity": "high",
                    "description": "Unstable tunnels",
                    "impact": "Dangerous work conditions",
                },
                {
                    "type": "resource_scarcity",
                    "severity": "medium",
                    "description": "No timber for supports",
                    "impact": "Must import or use alternative materials",
                },
                {
                    "type": "external_threat",
                    "severity": "high",
                    "description": "Territorial creatures",
                    "impact": "Constant threat to miners",
                },
            ],
            "trade_hub": [
                {
                    "type": "external_threat",
                    "severity": "high",
                    "description": "Pirates/raiders",
                    "impact": "Need for armed escort",
                },
                {
                    "type": "resource_scarcity",
                    "severity": "medium",
                    "description": "Limited fresh water",
                    "impact": "Water trade is profitable",
                },
                {
                    "type": "environmental",
                    "severity": "low",
                    "description": "Seasonal storms",
                    "impact": "Trade routes affected",
                },
            ],
            "fortress": [
                {
                    "type": "environmental",
                    "severity": "medium",
                    "description": "Harsh winters",
                    "impact": "Supplies must be stockpiled",
                },
                {
                    "type": "resource_scarcity",
                    "severity": "high",
                    "description": "No arable land nearby",
                    "impact": "Dependent on supply lines",
                },
                {
                    "type": "external_threat",
                    "severity": "critical",
                    "description": "Constant siege threat",
                    "impact": "Always on high alert",
                },
            ],
            "pilgrimage": [
                {
                    "type": "environmental",
                    "severity": "medium",
                    "description": "Remote mountain location",
                    "impact": "Difficult journey for pilgrims",
                },
                {
                    "type": "resource_scarcity",
                    "severity": "low",
                    "description": "Limited farmland",
                    "impact": "Imports food for visitors",
                },
                {
                    "type": "external_threat",
                    "severity": "medium",
                    "description": "Religious persecution",
                    "impact": "Must remain vigilant",
                },
            ],
        },
...
EXAMPLE_LOCATION = {
    ...
    "culture": {
        ...
        "valued_skills": [
            "Tunnel sense (navigating in darkness)",
            "Crystal identification",
            "Mask-making",
            "Balance (for precarious work)",
        ],
        "revered_professions": [
            "Master Miners",
            "Mask-makers",
            "Healers (crystal dust sickness)",
        ],
    ...
    "reputation": {
        ...
        "who_comes_here": [
            "Desperate fortune seekers",
            "Criminals fleeing justice",
            "Merchants willing to brave the danger",
        ],
        "who_avoids": [
            "Families (too dangerous for children)",
            "Cowards (fear of the dark)",
        ],
    },
    "emergent_details": {
        ...
        "landmarks": [
            {
                ...
                "description": "A cavern wall carved with the names of every miner lost to the tunnels",
                "significance": "Honors the dead, reminds living of the dangers",
            },
            {
                "name": "The Mask Maker's Circle",
                "description": "Central plaza where master mask-makers display their creations",
                "significance": "Second most important place after the mines themselves",
            },
        ],
        "notable_buildings": [
            {
                "name": "The Gilded Cage",
                "description": "Miners' tavern with reinforced ceilings and sad songs",
                "type": "Tavern",
            },
            {
                "name": "Hall of Light",
                "description": "Healing center powered by the brightest crystals",
                "type": "Hospital",
            },
        ],
        ...
        "color_palette": [
            "Deep grays",
            "Crystalline blues and purples (from crystal light)",
            "Sooty blacks",
            "Gold (for the precious crystals)",
        ],
        "common_materials": [
            "Stone (imported timber is too expensive)",
            "Crystal fragments (common building装饰)",
            "Metal (reinforcement for tunnels)",
        ],
    },
    "story_hooks": [
