...
class TestGitHubIssueCreation:
    ...
    def test_successful_issue_creation(self, mock_post):
        ...
        assert (
            call_args[0][0]
            == "https://api.github.com/repos/zedarvates/StoryCore-Engine/issues"
        )
...
class TestGitHubAPIError:
    ...
    def test_error_with_response_details(self):
        ...
        error = GitHubAPIError(
            "Rate limit error", error_code=403, response_details=response_details
        )
    ...
    def test_error_to_dict(self):
        ...
        error = GitHubAPIError(
            "Resource not found", error_code=404, response_details=response_details
        )
