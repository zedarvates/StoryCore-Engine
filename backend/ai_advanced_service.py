...
class MagicMaskService:
    ...
    def __init__(self):
        self.supported_types = [
            MaskType.PERSON, MaskType.FACE, MaskType.HAIR, 
            MaskType.BODY, MaskType.HANDS, MaskType.BACKGROUND
        ]
    ...
    def generate_mask_frame(
        ...
        try:
            ...
            return self._opencv_segmentation(
                frame_path, output_path, mask_type
            )
        ...
        try:
            ...
            while True:
                ...
                success, msg = self.generate_mask_frame(
                    temp_frame, mask_path,
                    config.mask_type, config.refine_edges
                )
...
class DepthMapService:
    ...
    def _simple_depth(
        ...
        try:
            ...
            if config.blur > 0:
                depth = cv2.GaussianBlur(depth, (config.blur*2+1, config.blur*2+1), 0)
...
class BloomEffectService:
    ...
    def __init__(self, ffmpeg_path: str = "ffmpeg"):
        ...
        self.presets = {
            ...
            BloomIntensity.ANAMORPHIC: {"threshold": 0.7, "radius": 40, "strength": 0.6, "ratio": 2.35},
        }
    ...
    def apply_bloom(
        ...
        try:
            ...
            # Get preset values
            preset = self.presets.get(config.intensity, self.presets[BloomIntensity.MODERATE])
            ...
            # Build FFmpeg filter
            bloom_filter = f"[0:v]split[base][bloom];" \
...
class AISubtitleService:
    ...
    def __init__(self, ffmpeg_path: str = "ffmpeg"):
        ...
        self.style_templates = {
            SubtitleStyle.DEFAULT: {
                "fontsize": 24, "fontcolor": "white", "outline": 2, "outlinecolor": "black"
            },
            SubtitleStyle.NETFLIX: {
                "fontsize": 28, "fontcolor": "white", "outline": 3, "outlinecolor": "black", "bold": 1
            },
            SubtitleStyle.YOUTUBE: {
                "fontsize": 22, "fontcolor": "white", "outline": 2, "outlinecolor": "black", "shadow": 1
            },
            SubtitleStyle.CINEMATIC: {
                "fontsize": 32, "fontcolor": "white", "outline": 0, "box": 1, "boxcolor": "black@0.5"
            },
            SubtitleStyle.MINIMAL: {
                "fontsize": 20, "fontcolor": "white", "outline": 1, "outlinecolor": "gray"
            },
            SubtitleStyle.BOLD: {
                "fontsize": 26, "fontcolor": "yellow", "outline": 2, "outlinecolor": "black", "bold": 1
            },
            SubtitleStyle.OUTLINE: {
                "fontsize": 24, "fontcolor": "white", "outline": 4, "outlinecolor": "blue"
            },
            SubtitleStyle.GLOW: {
                "fontsize": 28, "fontcolor": "white", "shadow": 3, "shadowcolor": "cyan"
            },
        }
    ...
    def apply_subtitles_to_video(
        ...
        try:
            # First transcribe
            temp_srt = tempfile.NamedTemporaryFile(suffix=".srt", delete=False, mode='w')
            temp_srt.close()
            ...
            # Get style
            style = self.style_templates.get(config.style, self.style_templates[SubtitleStyle.DEFAULT])
    ...
    def _composite_with_background_image(
        ...
        try:
            ...
            if color_match:
                ...
                bg_hsv[:,:,2] = np.clip(bg_hsv[:,:,2] * (fg_mean / bg_hsv[:,:,2].mean()), 0, 255)
...
def create_background_service(ffmpeg_path: str = "ffmpeg") -> BackgroundReplacementService:
