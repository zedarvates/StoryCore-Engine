...
- Camera Movement: {camera_movement}""",
                variables=[
                    PromptVariable(
                        "scene_description", "Description de la scène", "", True
                    ),
                    ...
                    PromptVariable(
                        "camera_movement", "Mouvement de caméra", "static", False
                    ),
                ],
...
{json_params}""",
                variables=[
                    PromptVariable(
                        "foundation_prompt", "Prompt de base généré", "", True
                    ),
                    ...
                    PromptVariable(
                        "json_params", "Paramètres JSON additionnels", "{}", False
                    ),
                ],
...
[/OUTPUT]""",
                variables=[
                    PromptVariable(
                        "identity_description",
                        "Description du personnage verrouillé",
                        "",
                        True,
                    ),
                    PromptVariable(
                    ...
                    PromptVariable(
                        "camera_type", "Type de caméra", "professional", False
                    ),
                    PromptVariable(
                        "camera_movement", "Mouvement", "smooth dolly", False
                    ),
...
MAINTAIN THIS IDENTITY ACROSS ALL SCENES.""",
                variables=[
                    ...
                    PromptVariable(
                        "distinctive_features", "Traits distinctifs", "none", False
                    ),
                    PromptVariable(
                        "personality_traits", "Traits de personnalité", "", False
                    ),
...
[/OUTPUT]""",
                variables=[
                    ...
                    PromptVariable(
                        "emphasis_pattern", "Pattern d'emphase", "normal", False
                    ),
                    PromptVariable("text", "Texte à prononcer", "", True),
                    PromptVariable("audio_format", "Format audio", "wav", False),
                    PromptVariable(
                        "sample_rate", "Taux d'échantillonnage", "44100", False
                    ),
...
[/CAMERA]""",
                variables=[
                    ...
                    PromptVariable(
                        "lighting_type", "Type d'éclairage", "natural", False
                    ),
                    PromptVariable(
                        "lighting_direction", "Direction de la lumière", "front", False
                    ),
                    PromptVariable(
                        "lighting_intensity", "Intensité lumineuse", "medium", False
                    ),
                    PromptVariable(
                        "color_temperature", "Température de couleur", "neutral", False
                    ),
                    PromptVariable("mood", "Ambiance", "neutral", False),
                    PromptVariable(
                        "atmospheric_effects", "Effets atmosphériques", "none", False
                    ),
                    PromptVariable(
                        "particle_effects", "Effets de particules", "none", False
                    ),
                    PromptVariable(
                        "camera_position", "Position de caméra", "eye level", False
                    ),
                    PromptVariable(
                        "camera_angle", "Angle de caméra", "straight on", False
                    ),
                    PromptVariable("lens_type", "Type d'objectif", "50mm", False),
                    PromptVariable(
                        "depth_of_field", "Profondeur de champ", "deep", False
                    ),
                ],
...
Output as JSON with keys: title, description, tags, thumbnail_suggestions""",
                variables=[
                    ...
                    PromptVariable(
                        "description_preview", "Aperçu de la description", "", False
                    ),
                    PromptVariable(
                        "video_category", "Catégorie YouTube", "Entertainment", False
                    ),
                    PromptVariable("primary_keyword", "Mot-clé principal", "", True),
                    PromptVariable(
                        "secondary_keywords", "Mots-clés secondaires", "", False
                    ),
                    PromptVariable(
                        "target_audience", "Audience cible", "general", False
                    ),
...
This identity must be maintained consistently across all generations.""",
                variables=[
                    ...
                    PromptVariable(
                        "identity_type", "Type (person, object, style)", "person", False
                    ),
                    PromptVariable(
                        "primary_features", "Caractéristiques principales", "", True
                    ),
                    PromptVariable(
                        "distinctive_marks", "Marques distinctives", "none", False
                    ),
                ],
    ...
    def update_template(
        ...
        if "name" in updates and updates["name"] != template.name:
            if updates["name"] in self._name_index:
                raise ValueError(
                    f"Un template avec le nom '{updates['name']}' existe déjà"
                )
    ...
    def compose_templates(
        self, foundation_id: str, execution_id: str, variables: Dict[str, Any]
    ) -> Dict[str, Any]:
