...
class GitHubAPIError(Exception):
    ...
    def __init__(
        ...
        self.recovery_suggestions = (
            recovery_suggestions
            or self.RECOVERY_SUGGESTIONS.get(
...
def create_github_issue(
    ...
    try:
        ...
        request_body = {"title": issue_title, "body": issue_body, "labels": labels}
        ...
        logger.error(error_msg)
        raise GitHubAPIError(message=error_msg, error_code=GitHubAPIError.NETWORK_ERROR)
        ...
        logger.error(error_msg)
        raise GitHubAPIError(message=error_msg, error_code=GitHubAPIError.UNKNOWN_ERROR)
