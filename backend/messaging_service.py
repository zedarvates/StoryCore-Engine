...
class MessagingService:
    ...
    async def send_telegram_message(self, message: str, chat_id: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        if not target_chat_id:
            return {"success": False, "error": "Telegram Chat ID not provided or configured"}
    ...
    async def send_discord_message(self, message: str, webhook_url: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        if not target_url:
            return {"success": False, "error": "Discord Webhook URL not provided or configured"}
