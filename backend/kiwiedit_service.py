...
class KiwieditService:
    ...
    async def edit_video(
        ...
        logger.info(f"Starting Kiwiedit job {job_id}: {action} {target_object} in {video_path}")
    ...
    async def hifi_paint(
        ...
        """
        logger.info(f"Hi-Fi Painting '{prop_image_path}' onto '{anchor_object}' in {video_path}")
