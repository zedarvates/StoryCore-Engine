    ...
    SFX_VARIANTS: Dict[str, List[SFXVariant]] = {
        "ui_click": [
            SFXVariant(
                id="click_light",
                name="Light Click",
                file_pattern="ui_click_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="click_heavy",
                name="Heavy Click",
                file_pattern="ui_click_heavy_*.wav",
                volume_offset=3,
            ),
            SFXVariant(
                id="click_tactile",
                name="Tactile Click",
                file_pattern="ui_click_tactile_*.wav",
                volume_offset=-2,
            ),
        ],
        "ui_hover": [
            SFXVariant(
                id="hover_soft",
                name="Soft Hover",
                file_pattern="ui_hover_soft_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="hover_sharp",
                name="Sharp Hover",
                file_pattern="ui_hover_sharp_*.wav",
                volume_offset=-3,
            ),
        ],
        "transition_whoosh": [
            SFXVariant(
                id="whoosh_fast",
                name="Fast Whoosh",
                file_pattern="whoosh_fast_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="whoosh_slow",
                name="Slow Whoosh",
                file_pattern="whoosh_slow_*.wav",
                volume_offset=-3,
            ),
            SFXVariant(
                id="whoosh_power",
                name="Power Whoosh",
                file_pattern="whoosh_power_*.wav",
                volume_offset=3,
            ),
        ],
        "notification_chime": [
            SFXVariant(
                id="chime_bell",
                name="Bell",
                file_pattern="chime_bell_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="chime_ding",
                name="Ding",
                file_pattern="chime_ding_*.wav",
                volume_offset=-2,
            ),
            SFXVariant(
                id="chime_alert",
                name="Alert",
                file_pattern="chime_alert_*.wav",
                volume_offset=2,
            ),
        ],
        "ambient_nature": [
            SFXVariant(
                id="nature_wind",
                name="Wind",
                file_pattern="ambient_wind_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="nature_birds",
                name="Birds",
                file_pattern="ambient_birds_*.wav",
                volume_offset=-3,
            ),
            SFXVariant(
                id="nature_water",
                name="Water",
                file_pattern="ambient_water_*.wav",
                volume_offset=-2,
            ),
            SFXVariant(
                id="nature_forest",
                name="Forest",
                file_pattern="ambient_forest_*.wav",
                volume_offset=0,
            ),
        ],
        "ambient_urban": [
            SFXVariant(
                id="urban_traffic",
                name="Traffic",
                file_pattern="urban_traffic_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="urban_crowd",
                name="Crowd",
                file_pattern="urban_crowd_*.wav",
                volume_offset=-2,
            ),
            SFXVariant(
                id="urban_construction",
                name="Construction",
                file_pattern="urban_construction_*.wav",
                volume_offset=1,
            ),
        ],
        "weapons": [
            SFXVariant(
                id="weapon_gun_shot",
                name="Gun Shot",
                file_pattern="weapon_gun_*.wav",
                volume_offset=4,
            ),
            SFXVariant(
                id="weapon_blade",
                name="Blade",
                file_pattern="weapon_blade_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="weapon_laser",
                name="Laser",
                file_pattern="weapon_laser_*.wav",
                volume_offset=-1,
            ),
            SFXVariant(
                id="weapon_explosion",
                name="Explosion",
                file_pattern="weapon_explosion_*.wav",
                volume_offset=6,
            ),
        ],
        "footsteps": [
            SFXVariant(
                ...
                name="Concrete",
                file_pattern="footsteps_concrete_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="footsteps_wood",
                name="Wood",
                file_pattern="footsteps_wood_*.wav",
                volume_offset=-2,
            ),
            SFXVariant(
                id="footsteps_grass",
                name="Grass",
                file_pattern="footsteps_grass_*.wav",
                volume_offset=-4,
            ),
            SFXVariant(
                id="footsteps_metal",
                name="Metal",
                file_pattern="footsteps_metal_*.wav",
                volume_offset=1,
            ),
        ],
        "impacts": [
            SFXVariant(
                id="impact_body",
                name="Body Hit",
                file_pattern="impact_body_*.wav",
                volume_offset=3,
            ),
            SFXVariant(
                id="impact_metal",
                name="Metal Hit",
                file_pattern="impact_metal_*.wav",
                volume_offset=2,
            ),
            SFXVariant(
                id="impact_wood",
                name="Wood Hit",
                file_pattern="impact_wood_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="impact_glass",
                name="Glass Break",
                file_pattern="impact_glass_*.wav",
                volume_offset=-1,
            ),
        ],
        "explosions": [
            SFXVariant(
                ...
                file_pattern="explosion_small_*.wav",
                volume_offset=2,
            ),
            SFXVariant(
                id="explosion_medium",
                name="Medium Explosion",
                file_pattern="explosion_medium_*.wav",
                volume_offset=4,
            ),
            SFXVariant(
                id="explosion_large",
                name="Large Explosion",
                file_pattern="explosion_large_*.wav",
                volume_offset=6,
            ),
            SFXVariant(
                id="explosion_nuclear",
                name="Nuclear Explosion",
                file_pattern="explosion_nuclear_*.wav",
                volume_offset=8,
            ),
        ],
        "vehicles": [
            SFXVariant(
                id="vehicle_car",
                name="Car",
                file_pattern="vehicle_car_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="vehicle_helicopter",
                name="Helicopter",
                file_pattern="vehicle_helicopter_*.wav",
                volume_offset=2,
            ),
            SFXVariant(
                id="vehicle_engine",
                name="Engine",
                file_pattern="vehicle_engine_*.wav",
                volume_offset=-2,
            ),
            SFXVariant(
                id="vehicle_siren",
                name="Siren",
                file_pattern="vehicle_siren_*.wav",
                volume_offset=3,
            ),
        ],
        "weather": [
            SFXVariant(
                id="weather_rain",
                name="Rain",
                file_pattern="weather_rain_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="weather_thunder",
                name="Thunder",
                file_pattern="weather_thunder_*.wav",
                volume_offset=4,
            ),
            SFXVariant(
                id="weather_lightning",
                name="Lightning",
                file_pattern="weather_lightning_*.wav",
                volume_offset=-3,
            ),
            SFXVariant(
                id="weather_storm",
                name="Storm",
                file_pattern="weather_storm_*.wav",
                volume_offset=1,
            ),
        ],
        "doors": [
            SFXVariant(
                id="door_wood_open",
                name="Wood Door Open",
                file_pattern="door_wood_open_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="door_wood_close",
                name="Wood Door Close",
                file_pattern="door_wood_close_*.wav",
                volume_offset=-2,
            ),
            SFXVariant(
                id="door_metal",
                name="Metal Door",
                file_pattern="door_metal_*.wav",
                volume_offset=2,
            ),
            SFXVariant(
                id="door_squeak",
                name="Squeaky Door",
                file_pattern="door_squeak_*.wav",
                volume_offset=-4,
            ),
        ],
        "glass": [
            SFXVariant(
                id="glass_break",
                name="Glass Break",
                file_pattern="glass_break_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="glass_crack",
                name="Glass Crack",
                file_pattern="glass_crack_*.wav",
                volume_offset=-3,
            ),
            SFXVariant(
                id="glass_shatter",
                name="Glass Shatter",
                file_pattern="glass_shatter_*.wav",
                volume_offset=2,
            ),
        ],
        "cloth": [
            SFXVariant(
                id="cloth_movement",
                name="Cloth Movement",
                file_pattern="cloth_movement_*.wav",
                volume_offset=-4,
            ),
            SFXVariant(
                id="cloth_rip",
                name="Cloth Rip",
                file_pattern="cloth_rip_*.wav",
                volume_offset=0,
            ),
            SFXVariant(
                id="cloth_button",
                name="Button",
                file_pattern="cloth_button_*.wav",
                volume_offset=-6,
            ),
        ],
    }
    ...
    async def play_sfx(
        ...
        try:
            ...
            if variant >= len(variants):
                logger.warning(
                    f"Variant {variant} not available for {category}, using 0"
                )
                variant = 0
            ...
            final_volume = (
                volume
                * self._volume_master
                * (10 ** (selected_variant.volume_offset / 20))
            )

            # In production, this would actually play the sound
            sound_id = (
                f"sfx_{category}_{selected_variant.id}_{datetime.now().timestamp()}"
            )
...
class SFXProfileBuilder:
    ...
    def set_intensity(self, intensity: str) -> "SFXProfileBuilder":
        ...
        self._intensity = (
            intensity.lower() if intensity.lower() in valid_intensities else "medium"
        )
        return self
    ...
    def enable_muffling(
        self, muffling_type: str = "low_pass_dynamic", context: str = ""
    ) -> "SFXProfileBuilder":
    ...
    def add_filter(
        self, filter_type: str, params: Dict[str, Any]
    ) -> "SFXProfileBuilder":
    ...
    def set_eq(
        self, low_gain: float = 0, mid_gain: float = 0, high_gain: float = 0
    ) -> "SFXProfileBuilder":
        """Set EQ parameters"""
        self._filters["eq"] = {
            "low_gain": low_gain,
    ...
    def set_limiter(
        self, threshold: float = -3.0, release: float = 0.05
    ) -> "SFXProfileBuilder":
    ...
    def set_reverb(
        self, room_size: float = 0.5, damping: float = 0.5, wet_level: float = 0.3
    ) -> "SFXProfileBuilder":
    ...
    def set_sync(
        self, align_music: bool = True, align_action: bool = True, ducking: bool = True
    ) -> "SFXProfileBuilder":
    ...
    def build(self) -> SFXProfile:
        ...
        muffling = MufflingSettings(
            enabled=self._muffling_enabled, muffling_type=self._muffling_type
        )
        ...
        logger.info(
            f"SFXProfile {profile.id} built successfully with {len(tracks)} tracks"
        )
        return profile
    ...
    def _build_tracks(self) -> List[SFXTrack]:
        ...
        action_track = SFXTrack(
            ...
            parameters={"action_type": self._action_type, "intensity": self._intensity},
        ...
        env_track = SFXTrack(
            ...
            parameters={"environment": self._environment},
            volume=-12.0,
        )
        ...
        stylized_track = SFXTrack(
            ...
            parameters={"style": "glitch, bass drops, resonances"},
            volume=-6.0,
            filters=self._filters,
        )
        ...
        bullet_time_track = SFXTrack(
            ...
            parameters={"time_stretch": True, "pitch_down": True},
            volume=-3.0,
            muffling=MufflingSettings(
                enabled=True,
    ...
    def _generate_bullet_time_prompt(self) -> str:
        ...
        muffling_desc = (
            "sous l'eau" if self._muffling_context == "underwater" else "bullet time"
        )
        return (
