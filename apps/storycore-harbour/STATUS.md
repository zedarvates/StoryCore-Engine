...
- The generation and repair prompts now require a compact result below 12,000 characters: exactly three scenes, one shot per scene, bounded characters/locations, and bounded prose. Local 53-test, contract, fixture, corpus, synchronization, and strict-validation gates pass.
