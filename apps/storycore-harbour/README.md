...
- 53 Node tests covering the project contract, bounded diagnostic subsets, privacy-safe failure diagnostics, model-output normalization, demo artifacts, acceptance mode, acceptance evaluator, and official Anna Host API harness;
