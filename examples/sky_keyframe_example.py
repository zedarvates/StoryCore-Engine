...
def example_1_basic_earth():
    ...
    generator.setup_atmosphere(
        world_type=WorldType.EARTH, time_of_day=12.0, latitude=45.0
    )

    # Setup camera
    generator.setup_camera(position=(0, 1.6, 0), look_at=(0, 1.6, 10), fov=60.0)
