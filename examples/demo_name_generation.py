...
def demonstrate_archetype_based():
    ...
    for archetype in archetypes:
        ...
        for i in range(3):
            name = generator.generate_name(genre="fantasy", archetype_role=archetype)
            print(f"  {i + 1}. {name}")
...
def demonstrate_cultural_context():
    ...
    for culture in cultures:
        ...
        for i in range(3):
            name = generator.generate_name(culture=culture, genre="fantasy")
            print(f"  {i + 1}. {name}")
...
def demonstrate_personality_influence():
    ...
    for traits, description in trait_sets:
        ...
        for i in range(3):
            name = generator.generate_name(
                genre="fantasy", archetype_role="hero", personality_traits=traits
            )
            print(f"  {i + 1}. {name}")
