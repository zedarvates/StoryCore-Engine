...
async def github_webhook(
    ...
    # 2. Verify Signature
    if app.webhook_secret and not await verify_signature(request, app.webhook_secret, x_hub_signature_256):
    ...
    if amount > 0:
        ...
        return {"status": "processed", "amount": amount, "transaction_id": transaction.id if transaction else None}
