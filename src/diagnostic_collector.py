...
class DiagnosticCollector:
    ...
    def _get_storycore_version(self) -> str:
        ...
        try:
            ...
            log_diagnostic_error(
                component="version_detection", error=e, context={"fallback": "unknown"}
            )
            return "unknown"
    ...
    def collect_system_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                log_diagnostic_error(
                    component="python_version", error=e, context={"fallback": "unknown"}
                )
            ...
            try:
                ...
                log_diagnostic_error(
                    component="os_platform", error=e, context={"fallback": "unknown"}
                )
            ...
            try:
                ...
                log_diagnostic_error(
                    component="os_version", error=e, context={"fallback": "unknown"}
                )
            ...
            try:
                ...
                log_diagnostic_error(
                    component="language", error=e, context={"fallback": "en_US"}
                )

        except Exception as e:
            # Catch-all for unexpected errors
            log_diagnostic_error(
                component="system_info", error=e, context={"partial_info": system_info}
            )
    ...
    def collect_module_state(self, module_name: str) -> Dict[str, Any]:
        ...
        """
        module_context = {"active_module": module_name or "unknown", "module_state": {}}
        ...
        try:
            ...
            if module_name and module_name != "unknown":
                ...
                module_context["module_state"]["timestamp"] = (
                    datetime.utcnow().isoformat() + "Z"
                )
        except Exception as e:
            # If module state collection fails, continue with basic info
            log_diagnostic_error(
                component="module_state", error=e, context={"module_name": module_name}
            )
    ...
    def collect_stacktrace(self) -> Optional[str]:
        ...
        try:
            ...
            log_diagnostic_error(
                component="stacktrace", error=e, context={"action": "returning_none"}
            )
            return None
    ...
    def collect_memory_state(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                log_diagnostic_error(
                    component="memory_info", error=e, context={"fallback": 0}
                )
                memory_usage_mb = 0
            ...
            try:
                ...
                log_diagnostic_error(
                    component="memory_percent", error=e, context={"fallback": 0.0}
                )
                memory_percent = 0.0
            ...
            try:
                ...
                log_diagnostic_error(
                    component="system_memory", error=e, context={"fallback": "zeros"}
                )
            ...
            try:
                ...
                log_diagnostic_error(
                    component="process_status", error=e, context={"fallback": "unknown"}
                )
            ...
            try:
                ...
                log_diagnostic_error(
                    component="num_threads", error=e, context={"fallback": 0}
                )
            ...
            try:
                ...
                log_diagnostic_error(
                    component="cpu_percent", error=e, context={"fallback": 0.0}
                )
            ...
            try:
                ...
                log_diagnostic_error(
                    component="create_time", error=e, context={"skipping": True}
                )

            try:
                process_state["num_fds"] = (
                    process.num_fds() if hasattr(process, "num_fds") else None
                )
            except Exception as e:
                log_diagnostic_error(
                    component="num_fds", error=e, context={"fallback": None}
                )
            ...
            log_diagnostic_error(
                component="memory", error=e, context={"reason": "psutil_not_available"}
            )
            return {
                "memory_usage_mb": 0,
                "memory_percent": 0.0,
                ...
                "system_memory_available_mb": 0,
                "system_memory_percent": 0.0,
                "process_state": {"error": "psutil library not available"},
            }
        except Exception as e:
            # Error collecting memory state - return error information
            log_diagnostic_error(
                component="memory", error=e, context={"action": "returning_error_state"}
            )
            return {
                "memory_usage_mb": 0,
                "memory_percent": 0.0,
                ...
                "system_memory_available_mb": 0,
                "system_memory_percent": 0.0,
                "process_state": {"error": f"Failed to collect memory state: {str(e)}"},
            }
        ...
        try:
            ...
            try:
                    ...
                    if len(header) >= 8:
                        ...
                        # GIF: starts with GIF87a or GIF89a
                            ...
                            error_msg = (
                                ...
                                "Please ensure the file is a valid PNG, JPG, or GIF image."
                            )
                            log_error(
                                error_type="ValidationError",
                ...
                log_diagnostic_error(
                    ...
                    context={
                        "file_path": file_path,
                        "action": "allowing_based_on_extension",
                    },
                )
    ...
    def encode_screenshot(self, file_path: str) -> Optional[str]:
        ...
        try:
            ...
            log_diagnostic_error(
                component="screenshot", error=e, context={"file_path": file_path}
            )
            return None
                ...
                try:
                    ...
                    log_diagnostic_error(
                        ...
                        context={
                            ...
                            "action": "continuing_without_screenshot",
                        },
                    )
