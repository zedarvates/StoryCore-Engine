...
class FileMover:
    ...
    def move_file(
        self, source: Path, destination: Path, preserve_history: bool = True
    ) -> bool:
        """
            ...
            if preserve_history:
                ...
                if result:
                    ...
                    self._record_movement(
                        source, destination, MovementStatus.FAILED, error_msg
                    )
                    return False
            else:
    ...
    def move_batch(self, movements: List[FileMovement]) -> BatchResult:
        ...
        for movement in movements:
            ...
            success = self.move_file(
                movement.source, movement.destination, movement.preserve_history
            )
