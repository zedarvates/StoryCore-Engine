...
from .vision_object_analyzer import ObjectAttributes, get_object_analyzer
    ...
    async def create_object_from_image(
        ...
        try:
            ...
            result = ImageObjectResult(
                ...
                object_type=object_type or analysis_result.attributes.object_type
                if analysis_result.attributes
                else None,
                category=analysis_result.attributes.category
                if analysis_result.attributes
                else None,
            ...
            return ImageObjectResult(success=False, error_message=str(e))

    def _generate_hero_shot_prompt(
        self, attributes: ObjectAttributes, name: Optional[str] = None
    ) -> str:
    ...
    def get_object_categories(self) -> List[Dict[str, str]]:
        ...
        return [
            ...
            },
            {
                "id": "weapon",
                "name": "Weapon",
                "description": "Swords, guns, bows, etc.",
            },
            {"id": "tool", "name": "Tool", "description": "Hammers, wrenches, etc."},
            {
                "id": "clothing",
                "name": "Clothing",
                "description": "Shirts, dresses, armor",
            },
            {
                "id": "accessory",
                "name": "Accessory",
                "description": "Bags, belts, hats",
            },
            {"id": "vehicle", "name": "Vehicle", "description": "Cars, bikes, ships"},
            {
                "id": "container",
                "name": "Container",
                "description": "Boxes, bottles, chests",
            },
            {
                "id": "decoration",
                "name": "Decoration",
                "description": "Vases, statues, art",
            },
            ...
            },
            {
                "id": "book_document",
                "name": "Book/Document",
                "description": "Books, scrolls, papers",
            },
            ...
            {"id": "sports", "name": "Sports", "description": "Sports equipment"},
            {
                "id": "natural",
                "name": "Natural",
                "description": "Plants, rocks, shells",
            },
            {
                "id": "magical",
                "name": "Magical",
                "description": "Fantasy artifacts, potions",
            },
        ]
