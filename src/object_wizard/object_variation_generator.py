...
class ObjectVariationConfig:
    ...
    styles: List[ObjectStyle] = field(default_factory=lambda: [
        ObjectStyle.REALISTIC,
        ObjectStyle.PRODUCT_PHOTO
    ])
    materials: List[MaterialVariation] = field(default_factory=lambda: [
        MaterialVariation.WOOD,
        MaterialVariation.METAL
    ])
    conditions: List[ConditionVariation] = field(default_factory=lambda: [
        ConditionVariation.PRISTINE,
        ConditionVariation.WORN
    ])
...
class ObjectPromptBuilder:
    ...
    def build_prompt(
        ...
        style_template = cls.STYLE_TEMPLATES.get(style, cls.STYLE_TEMPLATES[ObjectStyle.REALISTIC])
        ...
        negative_parts = [
            ...
            "text", "watermark", "signature", "background clutter",
...
class ObjectVariationGenerator:
    ...
    def _generate_single_variation(
        ...
        try:
            ...
            cache_key = self._get_cache_key(object_id, style, material, condition, color)
