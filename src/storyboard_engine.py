...
class StoryboardEngine:
    ...
    def process_storyboard_generation(self, project_path: Path) -> Dict[str, Any]:
        ...
        if not shot_planning:
            raise FileNotFoundError(
                "Shot planning not found. Run 'storycore shot-planning' first."
            )
        ...
        storyboard_metadata = {
            ...
            "visual_composition_rules": self._generate_visual_composition_rules(
                storyboard_frames
            ),
            "puppet_placement_system": self._generate_puppet_placement_system(
                storyboard_frames
            ),
            "camera_guide_system": self._generate_camera_guide_system(
                storyboard_frames
            ),
            "lighting_guide_system": self._generate_lighting_guide_system(
                storyboard_frames
            ),
            ...
            "processing_metadata": {
                ...
                "visual_consistency_score": self._calculate_visual_consistency(
                    storyboard_frames
                ),
            },
        }
    ...
    def _create_storyboard_frame(
        self, shot: Dict[str, Any], scene_breakdown: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        visual_composition = self._generate_visual_composition(
            shot_type, composition, camera
        )

        # Generate puppet placement based on characters and shot framing
        puppet_placement = self._generate_puppet_placement(
            characters, shot_type, composition
        )
    ...
    def _generate_visual_composition(
        self,
        shot_type: Dict[str, Any],
    ...
    def _generate_puppet_placement(
        self,
        ...
        for character in characters:
            ...
            screen_position = self._calculate_character_screen_position(
                character, composition, shot_type
            )
            ...
            puppet_placement = {
                ...
                "performance_requirements": character.get(
    ...
    def _generate_lighting_guides(
        self, lighting: Dict[str, Any], shot_type: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        if shot_type["code"] in ["MCU", "CU", "ECU"] and lighting.get(
            "character_specific"
        ):
            lighting_elements.append(
                {
                    ...
                    "intensity": lighting["character_specific"].get(
                        "rim_light", "subtle"
                    ),
            ...
            motion_elements.append(
                {
                    ...
                    "direction": self._calculate_camera_movement_direction(
                        camera_movement
                    ),
                ...
                motion_elements.append(
                    {
                        ...
                        "character_id": character["character_id"],
                        "movement_direction": self._calculate_character_movement_direction(
                            character
                        ),
        ...
        annotations.append(
            {
                ...
                "content": shot["narrative_function"]["primary_purpose"]
                .replace("_", " ")
                .title(),
        ...
        annotations.append(
            {
                ...
                "content": shot["narrative_function"]["emotional_function"]
                .replace("_", " ")
                .title(),
    ...
    def _generate_frame_layer_placeholders(
        self, shot: Dict[str, Any], characters: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        layers = {
            ...
            "L3_background_characters": {
                ...
                "characters": [
                    c
                    for c in characters
                    if c.get("positioning", {}).get("depth_placement") == "background"
                ],
            },
            "L4_midground": {
                "layer_type": "environment",
            ...
            "L5_main_characters": {
                ...
                "characters": [
                    c
                    for c in characters
                    if c.get("positioning", {}).get("depth_placement") == "midground"
                ],
            },
            "L6_foreground_characters": {
                ...
                "characters": [
                    c
                    for c in characters
                    if c.get("positioning", {}).get("depth_placement") == "foreground"
                ],
            },
            "L7_foreground_props": {
                "layer_type": "props",
        ...
        for layer_name, layer_info in layers.items():
            layer_info["shot_relevance"] = self._calculate_layer_relevance(
                layer_name, shot
            )
            layer_info["generation_priority"] = self._calculate_generation_priority(
                layer_name, shot
            )
        ...
        return {
            ...
            "total_layers": 9,
            "layers": layers,
            "depth_sorting": sorted(
                layers.keys(), key=lambda x: layers[x]["depth"], reverse=True
            ),
            "character_distribution": self._analyze_character_layer_distribution(
                layers, characters
            ),
        }
    ...
    def _calculate_frame_boundaries(
        self, shot_type: Dict[str, Any], composition: Dict[str, Any]
    ) -> Dict[str, Any]:
        """Calculate frame boundaries based on shot type."""
    ...
    def _calculate_focal_areas(
        self, composition: Dict[str, Any], grid_type: str
    ) -> List[Dict[str, Any]]:
        ...
        if focal_point == "character_face":
            focal_areas.append(
                {
                    "area_type": "primary",
                    "coordinates": grid["intersection_points"][
                        0
    ...
    def _determine_character_depth(
        self, character: Dict[str, Any], shot_type: Dict[str, Any]
    ) -> str:
    ...
    def _calculate_character_screen_position(
        self,
    ...
    def _calculate_character_scale(
        self, shot_type: Dict[str, Any], depth_layer: str
    ) -> float:
    ...
    def _generate_pose_requirements(
        self, character: Dict[str, Any], shot_type: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _calculate_interaction_zones(
        self, puppet_placements: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
    ...
    def _generate_camera_movement_guides(
    ...
    def _calculate_camera_movement_direction(
        self, movement: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        return directions.get(
            movement_type, {"start": {"x": 0.5, "y": 0.5}, "end": {"x": 0.5, "y": 0.5}}
        )

    def _calculate_character_movement_direction(
    ...
    def _calculate_gaze_direction(
        self, character: Dict[str, Any], shot: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _calculate_layer_relevance(
        self, layer_name: str, shot: Dict[str, Any]
    ) -> float:
        ...
        relevance_map = {
            "ELS": {
                "L0_background": 1.0,
                "L1_far_background": 0.9,
                "L2_mid_background": 0.8,
                "L3_background_characters": 0.6,
                "L4_midground": 0.7,
                "L5_main_characters": 0.5,
                "L6_foreground_characters": 0.3,
                "L7_foreground_props": 0.2,
                "L8_effects": 0.4,
            },
            "LS": {
                "L0_background": 0.8,
                "L1_far_background": 0.7,
                "L2_mid_background": 0.9,
                "L3_background_characters": 0.7,
                "L4_midground": 0.9,
                "L5_main_characters": 0.8,
                "L6_foreground_characters": 0.4,
                "L7_foreground_props": 0.3,
                "L8_effects": 0.5,
            },
            "FS": {
                "L0_background": 0.6,
                "L1_far_background": 0.5,
                "L2_mid_background": 0.7,
                "L3_background_characters": 0.6,
                "L4_midground": 0.8,
                "L5_main_characters": 1.0,
                "L6_foreground_characters": 0.5,
                "L7_foreground_props": 0.4,
                "L8_effects": 0.6,
            },
            "MCU": {
                "L0_background": 0.4,
                "L1_far_background": 0.3,
                "L2_mid_background": 0.4,
                "L3_background_characters": 0.3,
                "L4_midground": 0.5,
                "L5_main_characters": 1.0,
                "L6_foreground_characters": 0.8,
                "L7_foreground_props": 0.6,
                "L8_effects": 0.7,
            },
            "CU": {
                "L0_background": 0.2,
                "L1_far_background": 0.1,
                "L2_mid_background": 0.2,
                "L3_background_characters": 0.1,
                "L4_midground": 0.3,
                "L5_main_characters": 0.8,
                "L6_foreground_characters": 1.0,
                "L7_foreground_props": 0.8,
                "L8_effects": 0.9,
            },
            "ECU": {
                "L0_background": 0.1,
                "L1_far_background": 0.05,
                "L2_mid_background": 0.1,
                "L3_background_characters": 0.05,
                "L4_midground": 0.2,
                "L5_main_characters": 0.6,
                "L6_foreground_characters": 1.0,
                "L7_foreground_props": 0.9,
                "L8_effects": 1.0,
            },
        }
    ...
    def _calculate_generation_priority(
        self, layer_name: str, shot: Dict[str, Any]
    ) -> int:
    ...
    def _analyze_character_layer_distribution(
        self, layers: Dict[str, Any], characters: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_characters": len(characters),
            "primary_character_layer": max(
                distribution.keys(), key=lambda k: distribution[k]
            )
            if distribution
            else None,
        }
    ...
    def _calculate_interaction_strength(
        ...
        screen_time_factor = (
            char1["screen_time_ratio"] + char2["screen_time_ratio"]
        ) / 2
    ...
    def _calculate_movement_path(self, movement: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return paths.get(
            movement_type, {"type": "static", "direction": "none", "length": 0}
        )

    def _generate_visual_composition_rules(
        ...
        composition_types = [
            frame["visual_composition"]["composition_type"]
            for frame in storyboard_frames
        ]
        [frame["visual_composition"]["focal_areas"] for frame in storyboard_frames]

        # Calculate composition consistency
        most_common_composition = max(
            set(composition_types), key=composition_types.count
        )
        composition_consistency = composition_types.count(
            most_common_composition
        ) / len(composition_types)
        ...
        return {
            ...
            "composition_distribution": {
                comp: composition_types.count(comp) for comp in set(composition_types)
            },
    ...
    def _generate_puppet_placement_system(
        self, storyboard_frames: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "character_consistency_analysis": self._analyze_character_consistency(
                character_consistency
            ),
            "depth_layer_usage": self._analyze_depth_layer_usage(all_placements),
            "puppet_scale_progression": self._analyze_puppet_scale_progression(
                all_placements
            ),
        }

    def _generate_camera_guide_system(
        self, storyboard_frames: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "camera_movement_analysis": self._analyze_camera_movements(
                camera_movements
            ),
            "lens_usage_pattern": self._analyze_lens_usage(storyboard_frames),
        }

    def _generate_lighting_guide_system(
        self, storyboard_frames: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "lighting_consistency_score": self._calculate_lighting_consistency(
                lighting_consistency
            ),
            "primary_lighting_setup": self._determine_primary_lighting_setup(
                all_lighting
            ),
            "lighting_progression": self._analyze_lighting_progression(
                storyboard_frames
            ),
        }

    def _generate_motion_system(
        self, storyboard_frames: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_energy_level": sum(
                [self._energy_to_numeric(e) for e in energy_levels]
            )
            / len(energy_levels)
            if energy_levels
            else 0,
    ...
    def _generate_annotation_system(
        self, storyboard_frames: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "annotation_type_distribution": self._analyze_annotation_distribution(
                all_annotations
            ),
            "annotation_density": len(all_annotations) / len(storyboard_frames)
            if storyboard_frames
            else 0,
        }

    def _generate_layer_placeholders(
        self, storyboard_frames: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        for frame in storyboard_frames:
            ...
            for layer_name, layer_info in layers.items():
                ...
                if (
                    layer_info["layer_type"] == "character"
                    and "characters" in layer_info
                ):
        ...
        return {
            ...
            "most_used_layers": sorted(
                layer_usage.keys(), key=lambda x: layer_usage[x], reverse=True
            )[:5],
            "generation_priority_order": self._calculate_global_generation_priority(
                layer_usage
            ),
        }

    def _calculate_composition_complexity(
        self, storyboard_frames: List[Dict[str, Any]]
    ) -> float:
    ...
    def _calculate_visual_consistency(
        ...
        composition_consistency = composition_types.count(most_common) / len(
            composition_types
        )
        consistency_factors.append(composition_consistency)

        # Check lighting consistency
        lighting_motivations = [
            frame["lighting_guides"]["lighting_motivation"]
            for frame in storyboard_frames
        ]
        ...
        character_consistency = self._calculate_character_position_consistency(
            storyboard_frames
        )
    ...
    def _update_project_with_storyboard(
        self, project_path: Path, storyboard_metadata: Dict[str, Any]
    ) -> None:
        ...
        project_data["processing_results"]["storyboard_visual"] = {
            ...
            "composition_complexity": storyboard_metadata["processing_metadata"][
                "composition_complexity"
            ],
            "puppet_count": storyboard_metadata["processing_metadata"]["puppet_count"],
            "visual_consistency_score": storyboard_metadata["processing_metadata"][
    ...
    def _analyze_visual_rhythm(
        ...
        return {
            "average_shot_duration": sum(shot_durations) / len(shot_durations)
            if shot_durations
            else 0,
    ...
    def _analyze_framing_progression(
        self, storyboard_frames: List[Dict[str, Any]]
    ) -> List[str]:
    ...
    def _analyze_character_consistency(
        self, character_consistency: Dict[str, List[Dict[str, Any]]]
    ) -> Dict[str, Any]:
    ...
    def _analyze_depth_layer_usage(
    ...
    def _analyze_puppet_scale_progression(
        self, all_placements: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
    ...
    def _analyze_guide_distribution(
        self, all_guides: List[Dict[str, Any]]
    ) -> Dict[str, int]:
    ...
    def _analyze_camera_movements(
        self, camera_movements: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "static_ratio": movement_counts.get("static", 0) / len(movement_types)
            if movement_types
            else 0,
            "dynamic_ratio": 1.0
            - (
                movement_counts.get("static", 0) / len(movement_types)
                if movement_types
                else 0
            ),
        }
    ...
    def _determine_primary_lighting_setup(
        self, all_lighting: List[Dict[str, Any]]
    ) -> str:
    ...
    def _analyze_lighting_progression(
        self, storyboard_frames: List[Dict[str, Any]]
    ) -> List[str]:
        ...
        for frame in storyboard_frames:
            ...
            primary_light = next(
                (
                    elem
                    for elem in lighting["lighting_elements"]
                    if elem["light_type"] == "key_light"
                ),
                None,
            )
            if primary_light:
    ...
    def _analyze_motion_distribution(
        self, all_motion: List[Dict[str, Any]]
    ) -> Dict[str, int]:
    ...
    def _analyze_annotation_distribution(
    ...
    def _calculate_global_generation_priority(
        self, layer_usage: Dict[str, float]
    ) -> List[str]:
    ...
    def _calculate_character_position_consistency(
        self, storyboard_frames: List[Dict[str, Any]]
    ) -> float:
