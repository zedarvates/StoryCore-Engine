...
class BaseAdvancedWorkflow(ABC):
    ...
    def get_capability_score(
        self, capability: WorkflowCapability, request: WorkflowRequest
    ...
    def _calculate_score_adjustments(
        ...
        if request.quality_mode == "fast" and hasattr(self, "supports_fast_inference"):
            adjustments += 0.2
        elif request.quality_mode == "quality" and hasattr(
            self, "supports_high_quality"
        ):
            adjustments += 0.2
        ...
        if (
            ...
            and request.output_resolution in self.supported_resolutions
        ):
            adjustments += 0.1
        ...
        if capability in [
            ...
            WorkflowCapability.IMAGE_EDITING,
        ]:
