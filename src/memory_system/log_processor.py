...
class LogProcessor:
    ...
    def translate_logs(self, target_language: str = "fr") -> Optional[Path]:
        """
        ...
        source_path = (
            self.clean_log_path if self.clean_log_path.exists() else self.raw_log_path
        )
        ...
        try:
            ...
            translated_content = self._translate_content(
                source_content, target_language
            )
    ...
    def _parse_entries_for_llm(self, content: str) -> List[Dict[str, Any]]:
        ...
        for line in lines:
            ...
            if line.startswith("[") and "] ACTION:" in line:
                ...
                action_type = line[
                    line.index("] ACTION:") + 10 :
                ].strip()  # +10 to skip '] ACTION: ' and strip whitespace
