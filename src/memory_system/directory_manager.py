...
class DirectoryManager:
    ...
    def _write_variables_file(self, file_path: Path) -> None:
        ...
        variables = Variables(
            schema_version="1.0", last_updated=datetime.now().isoformat(), variables={}
        )
    ...
    def _write_errors_file(self, file_path: Path) -> None:
        ...
        errors_dict = {"schema_version": "1.0", "errors": []}
    ...
    def validate_structure(self, project_path: Path) -> List[str]:
        ...
        missing_dirs = self._check_directories_recursive(
            project_path, self.DIRECTORY_STRUCTURE
        )
    ...
    def _check_directories_recursive(
        self, base_path: Path, structure: Dict[str, Any], prefix: str = ""
    ) -> List[str]:
        """
        ...
        for dir_name, subdirs in structure.items():
            ...
            if not dir_path.exists():
                ...
                missing.extend(
                    self._check_directories_recursive(dir_path, subdirs, relative_path)
                )
