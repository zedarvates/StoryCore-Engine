...
class BuildLogger:
    ...
    def log_file_creation(self, file_path: Path, triggered_by: str = "system") -> bool:
        """
    ...
    def log_asset_addition(
        self, asset_info: AssetInfo, triggered_by: str = "system"
    ) -> bool:
        """
    ...
    def log_memory_update(
        self, update_type: str, details: Dict[str, Any], triggered_by: str = "system"
    ) -> bool:
        """
        ...
        return self.log_action(
            ...
            parameters={"update_type": update_type, **details},
            triggered_by=triggered_by,
        )
    ...
    def log_decision(
        ...
        return self.log_action(
            ...
            affected_files=[],
            parameters={"decision": decision, **(details or {})},
            triggered_by=triggered_by,
        )
    ...
    def log_error(
        ...
        return self.log_action(
            ...
            parameters={"error_type": error_type, "description": description},
            triggered_by=triggered_by,
        )
    ...
    def _parse_log_entries(self, content: str) -> List[Action]:
        ...
        for line in lines:
            ...
            # Parse parameters
                ...
                ": " in line and not line.startswith("Triggered_By") and current_action
            ):
