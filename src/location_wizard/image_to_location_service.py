...
class ImageToLocationService:
    ...
    async def create_location_from_image(
        ...
        try:
            ...
            result = ImageLocationResult(
                ...
                location_type=location_type or analysis_result.attributes.location_type if analysis_result.attributes else None,
    ...
    def get_location_types(self) -> List[Dict[str, str]]:
        ...
        return [
            ...
            {"id": "architectural", "name": "Architectural", "description": "Building-focused"},
