...
from .models import Feature, FeatureCategory, RoadmapConfig
...
"""
    ...
    def format_quarter_section(self, quarter: str, features: List[Feature]) -> str:
        """
        ...
        sorted_categories = sorted(features_by_category.keys(), key=lambda c: c.value)
