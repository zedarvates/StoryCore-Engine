...
ASSETS = [
    (
        ...
        "Professional logo for StoryCore text, modern typography, minimal design",
        1024,
        256,
    ),
    (
        "storycore_logo_square",
        "Square app icon with SC monogram, modern minimal style",
        512,
        512,
    ),
    (
        "storycore_panel_placeholder",
        "Storyboard panel placeholder, neutral gray background, grid overlay",
        768,
        432,
    ),
    (
    ...
    (
        ...
        "Featured banner, dark gradient background, modern style",
        1024,
        320,
    ),
]
...
def create_qwen_workflow(name, prompt, width, height, seed=None):
    ...
    return {
        ...
        "2": {
            "class_type": "CLIPTextEncode",
            "inputs": {
                "text": "blurry, low quality, distorted, ugly, watermark, text, signature",
                "clip": ["3", 0],
            },
        },
        "3": {
