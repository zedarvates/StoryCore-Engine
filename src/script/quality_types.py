...
class ScriptQualityReport:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "dialogue": self.dialogue_analysis.to_dict()
            if self.dialogue_analysis
            else None,
            "pacing": self.pacing_analysis.to_dict() if self.pacing_analysis else None,
            "character_arcs": self.character_arc_check.to_dict()
            if self.character_arc_check
            else None,
            "conflict": self.conflict_analysis.to_dict()
...
class QualityVisualization:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {"radar": self.radar_data, "bar": self.bar_data}
