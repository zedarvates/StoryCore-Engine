...
class Qwen3TTSIntegration:
    ...
    def __init__(
        self, model_name: str = "qwen3-tts-1.7b", config_path: Optional[str] = None
    ):
        """
    ...
    def generate_voice(
        self, text: str, output_path: str, voice_params: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
    ...
    def generate_prompt(self, voice_type: str, emotion: str, language: str) -> str:
        """
