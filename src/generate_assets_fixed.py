...
ASSETS = [
    (
        ...
        "Professional logo design for StoryCore text",
        1024,
        256,
    ),
    ...
    (
        ...
        "Storyboard panel placeholder neutral gray background",
        768,
        432,
    ),
    (
...
def create_workflow(name, prompt, width, height):
    ...
    return {
        ...
        "8": {
            ...
            "inputs": {"samples": ["5", 0], "vae": ["4", 0]},
        },
        "9": {
            "class_type": "SaveImage",
            "inputs": {"images": ["8", 0], "filename_prefix": "StoryCore_" + name},
        },
    }
