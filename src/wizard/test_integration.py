...
class TestWizardIntegration(unittest.TestCase):
    ...
    def test_configuration_genre_defaults(self):
        ...
        self.assertEqual(config.genre["key"], "action")
        self.assertEqual(
            config.style_config["visual"]["lighting"], "high_contrast_dynamic"
        )
        self.assertEqual(
            config.style_config["visual"]["color_palette"], "saturated_vibrant"
        )
        ...
        self.assertEqual(
            config.style_config["visual"]["color_palette"], "muted_realistic"
        )
