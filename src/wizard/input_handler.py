    ...
    def prompt_choice(
        ...
        while True:
            ...
            try:
                ...
                self.output_stream.write("❌ Please enter a valid number\n")

    def prompt_multiline(self, question: str, end_marker: str = "END") -> str:
        """
        ...
        self.output_stream.write(f"\n{question}\n")
        self.output_stream.write(
            f"(Type '{end_marker}' on a new line when finished)\n\n"
        )
        self.output_stream.flush()
...
def prompt_choice(
    question: str, choices: List[tuple[str, str]], default: Optional[int] = None
) -> str:
    """Convenience function for choice input"""
    return _default_handler.prompt_choice(question, choices, default)


def prompt_multiline(question: str, end_marker: str = "END") -> str:
