...
from .story_documentation import generate_story_documentation
...
class FileWriter:
    ...
    def create_project_files(
        self, config: ProjectConfiguration, wizard_state=None
    ) -> bool:
        """
        ...
        try:
            ...
            if wizard_state:
                if not self._create_story_documentation(project_path, wizard_state):
                    display_message(
                        "Warning: Failed to generate some story documentation"
                    )
    ...
    def _write_project_json(
        self, project_path: Path, config: ProjectConfiguration
    ) -> bool:
        """
...
def create_project_files(
    config: ProjectConfiguration, base_dir: str = ".", wizard_state=None
) -> bool:
    """
