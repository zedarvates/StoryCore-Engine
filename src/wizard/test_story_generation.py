...
class TestStoryGenerationIntegration(unittest.TestCase):
        ...
        self.sample_story = Story(
            ...
            acts=[
                Act(
                    ...
                    beats=[
                        StoryBeat(
                            "Opening Image", "Establish tone and world", 3.0, 3, 1
                        ),
                        StoryBeat(
                            "Inciting Incident",
                ...
                Act(
                    ...
                    beats=[
                        ...
                        StoryBeat(
                            "Midpoint", "Major revelation or setback", 15.0, 8, 8
                        ),
                    ],
                ),
                Act(
    ...
    def test_collect_story_offers_generation_option(self):
        ...
        with patch.object(
            self.orchestrator, "_generate_story_automatically", return_value=True
        ) as mock_generate:
    ...
    def test_collect_story_manual_fallback(self):
        ...
        with patch.object(
            self.orchestrator, "_collect_story_manually", return_value=True
        ) as mock_manual:
            result = self.orchestrator._collect_story()
    ...
    def test_summary_shows_generated_story_details(self):
        ...
        with patch("src.wizard.wizard_orchestrator.display_message") as mock_display:
            ...
            generated_story_messages = [
                msg for msg in display_calls if "Generated automatically" in msg
            ]
            self.assertTrue(len(generated_story_messages) > 0)

            # Check for story details
            title_messages = [
                msg for msg in display_calls if self.sample_story.title in msg
            ]
    ...
    def test_summary_shows_manual_story_preview(self):
        ...
        self.orchestrator.state.story_content = (
            "This is a manually entered story content."
        )
        ...
        with patch("src.wizard.wizard_orchestrator.display_message") as mock_display:
            ...
            story_messages = [
                msg for msg in display_calls if "This is a manually" in msg
            ]
...
class TestStoryGeneratorIntegration(unittest.TestCase):
    ...
    def test_story_generation_basic(self):
        ...
        for i, (act, expected) in enumerate(zip(story.acts, expected_durations)):
            self.assertEqual(
                act.duration_percent, expected, f"Act {i + 1} duration incorrect"
            )
