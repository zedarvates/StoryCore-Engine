...
from .story_generator import ActType
...
class TemplateSelector:
    ...
    def _adjust_for_duration(
        self, template: StoryTemplate, duration: int
    ) -> StoryTemplate:
    ...
    def _apply_preferences(
        self, template: StoryTemplate, preferences: Dict[str, Any]
    ) -> StoryTemplate:
