...
class InfographicsGeneratorEngine:
    ...
    async def generate_infographic(self, visualizations: List[DataVisualization], background_prompt: Optional[str] = None) -> InfographicsResult:
        """
        ...
        try:
            ...
            return InfographicsResult(
                ...
                components_meta=[{"type": v.chart_type, "pos": (100, 100)} for v in visualizations],
