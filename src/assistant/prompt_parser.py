    ...
    def complete(self, prompt: str, **kwargs) -> str:
        ...
        response = self.client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a creative assistant that extracts structured information from creative prompts.",
                },
...
class PromptParser:
    ...
    def parse_prompt(self, prompt: str, language: str = "en") -> ParsedPrompt:
        ...
        try:
            ...
            logger.info(
                f"Successfully parsed prompt: {parsed_prompt.genre}, {len(parsed_prompt.scenes)} scenes, {len(parsed_prompt.characters)} characters"
            )
...
- Use {lang_name} for text values."""
    ...
    def _construct_parsed_prompt(
        self, data: Dict[str, Any], raw_prompt: str, language: str
    ) -> ParsedPrompt:
        """
        ...
        if missing_fields:
            ...
            if "visual_style" in data:
                data["visual"] = data.pop("visual_style")
