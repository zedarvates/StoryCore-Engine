...
from src.assistant.rlm_engine import RLMAgentCore, RLMSubtask
...
class StoryCoreRLMAgent(RLMAgentCore):
    ...
    async def call_llm(self, prompt: str, system_prompt: Optional[str] = None) -> str:
        ...
        request = LLMRequest(
            ...
            context=[{"role": "system", "content": system_prompt}] if system_prompt else None
        )
    ...
    async def trigger_n8n(self, webhook_id: str, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def create_n8n(self, name: str, nodes: List[Dict[str, Any]], connections: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def send_message(self, platform: str, text: str, target_id: Optional[str] = None) -> Dict[str, Any]:
        """
