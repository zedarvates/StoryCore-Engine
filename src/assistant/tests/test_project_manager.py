...
from src.assistant.exceptions import ResourceError, ValidationError, ProjectError
...
class TestProjectManager:
    ...
    def test_close_project_with_save(
        self, project_manager, project_dir, sample_project_data
    ):
    ...
    def test_close_project_without_save(
        self, project_manager, project_dir, sample_project_data
    ):
    ...
    def test_save_project_validation_failure(
        self, project_manager, project_dir, sample_project_data
    ):
