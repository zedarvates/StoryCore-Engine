...
class TestSecurityErrors:
    ...
    def test_security_error_to_dict(self):
        ...
        error = SecurityError(message="Access denied", code="ACCESS_DENIED")
    ...
    def test_path_validation_error(self):
        ...
        error = PathValidationError(
            path="/etc/passwd", reason="Path outside project directory"
        )
...
class TestValidationErrors:
    ...
    def test_validation_error_to_dict(self):
        ...
        error = ValidationError(
            message="Validation failed", details={"errors": ["Error 1", "Error 2"]}
        )
...
class TestResourceErrors:
    ...
    def test_project_not_found_error(self):
        ...
        error = ProjectNotFoundError(
            project_name="missing_project", available_projects=available
        )
    ...
    def test_storage_limit_exceeded_error(self):
        ...
        error = StorageLimitExceededError(
            limit_type="storage_size", current_value=55.0, limit_value=50.0
        )
    ...
    def test_storage_limit_file_count(self):
        ...
        error = StorageLimitExceededError(
            limit_type="file_count", current_value=250, limit_value=248
        )
...
class TestConfirmationErrors:
    ...
    def test_confirmation_without_size(self):
        ...
        error = ConfirmationRequiredError(
            message="Deletion requires confirmation", file_path="/path/to/file.txt"
        )
...
class TestErrorResponseFormat:
    ...
    def test_error_details_optional(self):
        ...
        error = ResourceError(message="Test error", code="TEST_ERROR")
    ...
    def test_error_suggested_action_optional(self):
        ...
        error = ValidationError(message="Test error", code="TEST_ERROR")
...
class TestErrorInheritance:
    ...
    def test_specialized_errors_inherit_from_base_categories(self):
        ...
        assert isinstance(
            ConfirmationRequiredError("msg", "path"), AssistantError
        )  # Inherits from AssistantError
