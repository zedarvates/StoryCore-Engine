...
class TestAutoSaveManager:
    ...
    def test_trigger_save_with_project(
        self, autosave_manager, project_manager, project_dir, sample_project_data
    ):
    ...
    def test_backup_rotation(
        ...
        for i in range(5):
            ...
            time.sleep(
                1.1
            )  # Delay to ensure different timestamps (1 second resolution)
    ...
    def test_automatic_save_interval(
    ...
    def test_modified_timestamp_updated(
        self, autosave_manager, project_manager, project_dir, sample_project_data
    ):
