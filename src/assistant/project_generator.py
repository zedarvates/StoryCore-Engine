...
class ProjectGenerator:
    ...
    def generate_project(
        self, prompt: str, language: str = "en", preferences: Optional[Dict] = None
    ) -> GeneratedProject:
        """
    ...
    def _create_metadata(
        self, project_name: str, parsed: ParsedPrompt
    ) -> ProjectMetadata:
        """
        Create project metadata.
    ...
    def _generate_scenes(
        self, parsed: ParsedPrompt, preferences: Optional[Dict]
    ) -> List[Scene]:
        """
    ...
    def _generate_characters(self, parsed: ParsedPrompt) -> List[Character]:
        ...
        for i, char_data in enumerate(parsed.characters):
            ...
            appearance = appearances.get(
                name, appearances.get(str(i), "Detailed appearance description.")
            )
    ...
    def _generate_appearances_batched(
        self, characters: List[Dict], parsed: ParsedPrompt
    ) -> Dict[str, str]:
        """
...
[RULES] Focus on physical features, clothing, and colors. No extra text."""
    ...
    def _generate_sequences(
        self, scenes: List[Scene], parsed: ParsedPrompt
    ) -> List[Sequence]:
        """
    ...
    def _generate_shot_description(
        self, scene: Scene, shot_index: int, total_shots: int
    ) -> str:
        """
