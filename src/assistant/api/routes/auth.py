...
def init_auth_routes(
    auth_mw: AuthenticationMiddleware, user_svc: UserService, usage_trk: UsageTracker
):
...
async def get_usage_stats(user: User = Depends(get_current_user)):
    ...
    return UsageStatsResponse(
        ...
        first_request_time=datetime.fromtimestamp(stats.first_request_time)
        if stats.first_request_time
        else None,
