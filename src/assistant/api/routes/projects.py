...
async def open_project(
    request: OpenProjectRequest, user: User = Depends(get_current_user)
):
    """
...
async def close_project(
    request: CloseProjectRequest, user: User = Depends(get_current_user)
):
    """
    ...
    try:
        ...
        return CloseProjectResponse(
            message="Project closed successfully", saved=request.save
        )
    except ProjectError as e:
...
async def delete_project(
    project_name: str, confirmed: bool = False, user: User = Depends(get_current_user)
):
    """
    Delete a project.
