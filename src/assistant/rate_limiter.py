...
class RateLimitExceededError(ResourceError):
    ...
    def __init__(
        self, user_id: str, limit: int, window_seconds: int, reset_time: float
    ):
        super().__init__(
...
class RateLimiter:
    ...
    def check_limit(self, user_id: str) -> RateLimitInfo:
        ...
        return RateLimitInfo(
            allowed=allowed, remaining=remaining, reset_time=reset_time, warning=warning
        )
    ...
    def get_user_stats(self, user_id: str) -> Dict[str, any]:
        ...
        return {
            ...
            "at_warning_threshold": request_count
            >= self.max_requests * self.warning_threshold,
        }
