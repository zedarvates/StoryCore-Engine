    ...
    def _initialize_panda3d(self):
        ...
        class PandaApp(ShowBase):
            ...
            def _setup_camera(self):
                ...
                logger.info(
                    f"Panda3D camera configured: FOV={camera.fov}, Position={camera.position}"
                )
            ...
            def _setup_lights(self):
                ...
                logger.info(
                    f"Configured {len(self.engine.current_scene.lights)} lights"
                )
...
def create_default_scene() -> Scene3D:
    ...
    # Add camera
    scene.camera = Camera3D(position=(10, -10, 10), target=(0, 0, 0), fov=45.0)
    ...
    scene.lights = [
        ...
        LightSource(light_type=LightType.AMBIENT, color=(0.2, 0.2, 0.3), intensity=0.5),
    ]
    ...
    scene.objects = [
        SceneObject(
            ...
            scale=(5, 5, 1),
            material=Material(
                diffuse_color=(0.3, 0.5, 0.2), specular_color=(0.1, 0.1, 0.1)
            ),
        ),
        SceneObject(
            name="test_object",
            ...
            position=(0, 0, 2),
            rotation=(0, 45, 0),
            material=Material(diffuse_color=(0.8, 0.2, 0.2), shininess=64.0),
        ),
    ]
