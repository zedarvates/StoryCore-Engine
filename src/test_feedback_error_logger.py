...
class TestFeedbackErrorLogger(unittest.TestCase):
    ...
    def test_diagnostic_error_logging(self):
        ...
        try:
            ...
            log_diagnostic_error(
                component="memory", error=e, context={"fallback": "minimal"}
            )
    ...
    def test_get_recent_errors(self):
        ...
        for i in range(5):
            log_error(
                error_type="TestError", message=f"Test error {i}", context={"index": i}
            )
    ...
    def test_value_truncation(self):
        ...
        log_validation_error(field="test_field", value=long_value, reason="Too long")
