...
try:
    ...
    from ai_character_engine import GeneratedCharacter
...
class DialogueContext:
    ...
    time_of_day: str = (
        "day"  # "dawn", "morning", "afternoon", "dusk", "night", "midnight"
    )
    situation: str = (
        "neutral"  # "combat", "meeting", "travel", "rest", "ceremony", "crisis"
    )
    weather: Optional[str] = None  # "sunny", "rainy", "stormy", "foggy", "snowy"
    mood: str = (
        "neutral"  # "tense", "peaceful", "mysterious", "epic", "joyful", "somber"
    )
...
class DialogueLine:
    ...
    dialogue: str
    emotion: (
        str  # "neutral", "happy", "angry", "sad", "surprised", "fearful", "determined"
    )
...
class DialogueScene:
    ...
    def to_script_format(self) -> str:
        ...
        lines = []
        lines.append(
            f"INT. {self.context.location.upper()} - {self.context.time_of_day.upper()}"
        )
...
ARCHETYPE_DIALOGUE_TEMPLATES = {
    ...
    # Ally/Sidekick
    "sidekick": {
        "opening": ["I'm with you.", "What do we do next?", "We've got your back."],
        "response": [
    ...
    "antagonist": {
        ...
        "closing": ["This isn't over.", "I'll remember this.", "Victory will be mine."],
        "conflict": [
            "You're outmatched.",
...
class DialogueAutomation:
    ...
    def _generate_lines(
        ...
        for i in range(num_lines):
            ...
            # Créer la ligne
            is_thought = template == DialogueTemplate.PARALLEL and i % 2 == 0
    ...
    def _get_archetype_templates(
        self, characters: List[GeneratedCharacter]
    ...
    def _personalize_dialogue(
        self, template: str, character: GeneratedCharacter, context: DialogueContext
    ) -> str:
    ...
    def _generate_gesture_note(
        self, character: GeneratedCharacter, context: DialogueContext, emotion: str
    ) -> Optional[str]:
    ...
    def _get_voice_direction(
        self, emotion: str, context: DialogueContext
    ) -> Optional[str]:
    ...
    def get_character_scenes(self, character_id: str) -> List[DialogueScene]:
...
# Factory function
def create_dialogue_automation(
    storage_dir: str = "data/dialogues",
) -> DialogueAutomation:
    """
