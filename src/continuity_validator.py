...
class ContinuityValidator:
        ...
        if characters_a and characters_b:
            ...
            for char_name in common_chars:
                ...
                if pos_a and pos_b:
                    ...
                    if (
                        x_delta > self.position_tolerance
                        or y_delta > self.position_tolerance
                    ):
                        violations.append(
                            ContinuityViolation(
                                ...
                                timestamp_a=timestamp_a,
                                timestamp_b=timestamp_b,
                                suggested_fix="Add transition shot or adjust character position to maintain spatial continuity",
                            )
                        )
    ...
    def generate_continuity_report(self, project_path: Path) -> Dict[str, Any]:
        """
