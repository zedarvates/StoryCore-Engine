...
class WizardStateManager:
    ...
    def save_state(self, state: WizardState) -> bool:
        ...
        try:
            ...
            state_dict = {
                ...
                "creation_method": state.creation_method.value
                if state.creation_method
                else None,
            ...
            if state.character_profile:
                state_dict["character_profile"] = self._serialize_character_profile(
    ...
    def load_state(self, session_id: str) -> Optional[WizardState]:
        ...
        try:
            ...
            if state_data.get("character_profile"):
                state.character_profile = self._deserialize_character_profile(
                    state_data["character_profile"]
                )
        ...
        for state_file in self.state_dir.glob("session_*.json"):
            try:
                ...
                if state_data.get("character_profile", {}).get("name"):
                    session_info["character_name"] = state_data["character_profile"][
                        "name"
                    ]
    ...
    def _deserialize_character_profile(self, data: Dict[str, Any]):
        ...
        profile.creation_method = CreationMethod(
            data.get("creation_method", "auto_generated")
        )
