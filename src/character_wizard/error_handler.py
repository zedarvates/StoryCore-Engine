...
class ValidationError(CharacterWizardError):
    ...
    def __init__(
        ...
        super().__init__(
            message, ErrorCategory.INPUT_VALIDATION, ErrorSeverity.MEDIUM, context
        )
        self.field = field
        self.value = value
...
class ImageProcessingError(CharacterWizardError):
    ...
    def __init__(
        self, message: str, image_path: str, context: Optional[ErrorContext] = None
    ):
        super().__init__(
            message, ErrorCategory.IMAGE_PROCESSING, ErrorSeverity.MEDIUM, context
        )
...
class GenerationError(CharacterWizardError):
    ...
    def __init__(
        self, message: str, generation_type: str, context: Optional[ErrorContext] = None
    ):
        super().__init__(
            message, ErrorCategory.GENERATION_FAILURE, ErrorSeverity.HIGH, context
        )
...
class IntegrationError(CharacterWizardError):
    ...
    def __init__(
        self, message: str, system: str, context: Optional[ErrorContext] = None
    ):
        super().__init__(
            message, ErrorCategory.INTEGRATION_ERROR, ErrorSeverity.HIGH, context
        )
        self.system = system
...
class CharacterWizardErrorHandler:
    ...
    def _handle_generation_error(self, error: GenerationError) -> RecoveryAction:
        ...
        if "timeout" in error.message.lower():
            ...
            "service" in error.message.lower() or "connection" in error.message.lower()
        ):
            return RecoveryAction(
                action_type="fallback",
    ...
    def _handle_configuration_error(
        self, error: CharacterWizardError
    ) -> RecoveryAction:
    ...
    def save_error_log(
        self, errors: List[CharacterWizardError], log_path: Path
    ) -> bool:
