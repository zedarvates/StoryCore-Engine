...
def get_trusted_sources(
    domain: str, config: Optional[Configuration] = None
) -> List[Source]:
    """
...
def get_source_by_url(
    url: str, config: Optional[Configuration] = None
) -> Optional[Source]:
    """
...
def is_source_trusted(
    url: str, domain: Optional[str] = None, config: Optional[Configuration] = None
) -> bool:
    """
...
def get_sources_by_type(
    source_type: str, config: Optional[Configuration] = None
) -> List[Source]:
    """
...
def get_source_statistics() -> Dict[str, int]:
    ...
    """
    stats = {"total_sources": 0, "by_domain": {}, "by_type": {}}
