...
class CacheEntry:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {"data": self.data, "timestamp": self.timestamp, "ttl": self.ttl}
...
class FactCheckerCache:
    ...
    def set(
        self, content: str, data: Dict[str, Any], ttl: Optional[int] = None
    ) -> None:
        """
...
def get_cache(
    cache_dir: Optional[Path] = None, default_ttl: int = 86400
) -> FactCheckerCache:
    """
