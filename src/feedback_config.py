...
class FeedbackConfig:
    ...
    def backend_proxy_url(self) -> str:
        ...
        return self.get(
            "backend_proxy_url", self.DEFAULT_CONFIG["feedback"]["backend_proxy_url"]
        )
    ...
    def auto_collect_logs(self) -> bool:
        ...
        return self.get(
            "auto_collect_logs", self.DEFAULT_CONFIG["feedback"]["auto_collect_logs"]
        )
    ...
    def max_log_lines(self) -> int:
        ...
        return self.get(
            "max_log_lines", self.DEFAULT_CONFIG["feedback"]["max_log_lines"]
        )
    ...
    def screenshot_max_size_mb(self) -> int:
        ...
        return self.get(
            ...
            self.DEFAULT_CONFIG["feedback"]["screenshot_max_size_mb"],
        )
    ...
    def enable_crash_reports(self) -> bool:
        ...
        return self.get(
            ...
            self.DEFAULT_CONFIG["feedback"]["enable_crash_reports"],
        )
    ...
    def privacy_consent_given(self) -> bool:
        ...
        return self.get(
            ...
            self.DEFAULT_CONFIG["feedback"]["privacy_consent_given"],
        )
