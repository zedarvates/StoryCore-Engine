...
class Validator:
    ...
    def validate_against_schema(
        self, data: Dict[str, Any], schema: Dict[str, Any], filename: str = "data"
    ) -> None:
        """Public schema validation method."""
        return self._validate_against_schema(data, schema, filename)

    def _validate_against_schema(
        self, data: Dict[str, Any], schema: Dict[str, Any], filename: str
    ) -> None:
        ...
        for field_name, field_schema in properties.items():
            if field_name in data:
                self._validate_field(
                    data[field_name], field_schema, f"{filename}.{field_name}"
                )


# Standalone function for external imports
def validate_against_schema(
    data: Dict[str, Any], schema: Dict[str, Any], filename: str = "data"
) -> None:
    ...
    def _validate_field(
        self, value: Any, field_schema: Dict[str, Any], field_path: str
    ) -> None:
            ...
            for req_field in required_fields:
                if req_field not in value:
                    raise ValidationError(
                        f"Missing required field '{req_field}' in {field_path}"
                    )
