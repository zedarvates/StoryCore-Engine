...
from src.end_to_end.data_models import ParsedPrompt, SystemCapabilities, OptimalConfig
...
class ConfigurationManager:
    ...
    QUALITY_TIERS = {
        ...
        "high": {"steps": 40, "cfg_scale": 8.0, "denoise": 0.85, "upscale_factor": 2.0},
        "ultra": {"steps": 50, "cfg_scale": 8.5, "denoise": 0.9, "upscale_factor": 2.0},
    }
    ...
    def determine_optimal_config(
        self, parsed_prompt: ParsedPrompt, system_capabilities: SystemCapabilities
    ) -> OptimalConfig:
        """
    ...
    def _calculate_resolution(
        self, aspect_ratio: str, quality_tier: str
    ) -> Tuple[int, int]:
        """
    ...
    def _select_quality_tier(self, system_capabilities: SystemCapabilities) -> str:
        """
    ...
    def _configure_generation_parameters(
        self, quality_tier: str, parsed_prompt: ParsedPrompt
    ) -> Dict[str, Any]:
        """
    ...
    def _calculate_shot_count(self, duration_seconds: int, video_type: str) -> int:
        """
        ...
        shots_per_second = self.SHOT_RECOMMENDATIONS.get(
            video_type_lower, self.SHOT_RECOMMENDATIONS["default"]
        )
    ...
    def _distribute_shot_durations(
        self, total_duration: int, shot_count: int
    ) -> List[int]:
        """
    ...
    def _generate_seeds(self, shot_count: int) -> Dict[str, int]:
        ...
        seeds = {"global": base_seed, "master_coherence": base_seed + 1, "shots": {}}
