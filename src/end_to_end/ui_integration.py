...
class UIIntegration:
    ...
    def register_connection_callback(self, callback: Callable[[ComfyUIStatus], None]):
        """
    ...
    def register_download_callback(
        self, callback: Callable[[str, DownloadProgress], None]
    ):
        """
    ...
    def register_generation_callback(
        self, callback: Callable[[GenerationProgress], None]
    ):
        """
    ...
    def get_generation_status_display(self) -> Dict[str, Any]:
        ...
        # Calculate progress
        progress = (
            (session.completed_items / session.total_items * 100)
    ...
    def trigger_download_progress_update(
        self, model_name: str, progress: DownloadProgress
    ):
        """
    ...
    def trigger_generation_progress_update(self, progress: GenerationProgress):
        """
