...
class NarrativeEngine:
    ...
    def _generate_augmented_prompt(
        self, description: str, global_style: Dict[str, str]
    ) -> str:
    ...
    def _check_shot_consistency(
        self, shot: Dict[str, Any], global_style: Dict[str, str]
    ) -> List[Dict[str, str]]:
        ...
        for category, global_value in global_style.items():
            conflicting_keywords = [
                kw
                for kw in self.style_keywords[category]
    ...
    def _is_significant_conflict(
        self, global_value: str, conflict: str, category: str
    ) -> bool:
