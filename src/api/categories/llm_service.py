...
class MockLLMClient:
    ...
    def complete(self, prompt: str, system_prompt: Optional[str] = None) -> str:
        ...
        if ("scene" in prompt_lower or "script" in prompt_lower) and (
            "breakdown" in prompt_lower or "break down" in prompt_lower
        ):
                ...
                "acts": [
                    {
                        "number": 1,
                        "name": "Setup",
                        "description": "Introduction of protagonist and world",
                    },
                    {
                        "number": 2,
                        "name": "Confrontation",
        ...
        return json.dumps(
            {
                ...
                "goals": [
                    "Prove her controversial theory",
                    "Honor her mentor's legacy",
                    "Overcome self-doubt",
                ],
                "conflicts": [
                    "Internal: guilt vs ambition",
                    "External: scientific establishment vs revolutionary ideas",
                ],
            }
        )
        ...
        return json.dumps(
            {
                ...
                "key_moments": [
                    ...
                    {
                        "moment": "Confrontation with board",
                        "impact": "Learns to stand up for beliefs",
                    },
                    {
                        "moment": "Final revelation",
                        "impact": "Accepts past and embraces future",
                    },
                ],
        ...
        return json.dumps(
            {
                ...
                "inconsistencies": [
                    "Timeline doesn't account for travel time between locations"
                ],
                "plot_holes": ["Unexplained knowledge of secret information"],
                "timeline_conflicts": [
                    "Events in Chapter 5 occur before setup in Chapter 4"
                ],
                "overall_score": 0.75,
            }
        )
        ...
        return json.dumps(
            {
                ...
                "locations": [
                    ...
                    {
                        "name": "The Archive",
                        "description": "Repository of classified research",
                    },
                ],
                "cultures": [
                    {
                        "name": "Scientific Elite",
                        "values": ["Knowledge", "Innovation", "Prestige"],
                    }
                ],
                "history": "Founded after the Quantum Revolution of 2045",
                "rules": [
                    "All discoveries must be peer-reviewed",
                    "Corporate sponsors have veto power",
                ],
            }
        )
