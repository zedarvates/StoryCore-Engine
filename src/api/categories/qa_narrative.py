...
- suggestions: array of objects with type, original, corrected, reason"""
    ...
    def check_readability(
        ...
        try:
            ...
            if gunning_fog > 12:
                recommendations.append(
                    "Reduce complex words (3+ syllables) for better accessibility"
                )
    ...
    def generate_report(
        ...
        try:
            ...
            if "coherence" in include_sections:
                coherence_response = self.check_coherence(
            ...
            if "character" in include_sections:
                character_response = self.check_character(
                    {"narrative": narrative}, context
                )
            ...
            if "dialogue" in include_sections:
                dialogue_response = self.check_dialogue(
                    {"narrative": narrative}, context
                )
            ...
            if "readability" in include_sections:
                readability_response = self.check_readability(
            ...
            if overall_score >= 0.8:
                summary = (
                    "Excellent narrative quality with strong coherence and development."
                )
                ...
                summary = (
                    "Narrative needs significant improvement across multiple areas."
                )
