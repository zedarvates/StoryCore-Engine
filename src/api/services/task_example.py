...
def example_basic_usage():
    ...
    try:
        ...
        task_id = task_manager.create_task(
            operation=example_long_running_operation, params={"steps": 5}
        )
...
def example_with_cancellation():
    ...
    try:
        # Create a task
        task_id = task_manager.create_task(
            operation=example_long_running_operation, params={"steps": 10}
        )
...
def example_concurrent_tasks():
    ...
    try:
        ...
        for i in range(5):
            task_id = task_manager.create_task(
                operation=example_long_running_operation, params={"steps": 3}
            )
