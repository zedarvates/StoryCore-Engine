...
class ScriptEngine:
    ...
    def process_script(self, script_text: str, project_path: Path) -> Dict[str, Any]:
        ...
        script_metadata = {
            ...
            "processing_metadata": {
                ...
                "estimated_duration_seconds": len(scenes)
                * 6,  # 6 seconds per scene default
        ...
        emotional_arcs = [
            {
                ...
                "start_emotion": detected_emotions[0]["emotion"]
                if detected_emotions
                else "calm",
                "peak_emotion": detected_emotions[1]["emotion"]
                if len(detected_emotions) > 1
                else "tension",
                "end_emotion": detected_emotions[-1]["emotion"]
                if detected_emotions
                else "calm",
        ...
        for pattern, beat_type in beat_patterns:
            ...
            for match in matches:
                ...
                beat = {
                    ...
                    "importance": "high"
                    if beat_type in ["climax", "inciting_incident"]
                    else "medium",
                }
        ...
        if not key_beats:
            key_beats = [
                ...
                },
                {
                    ...
                    "timestamp_estimate": 6,
                    "importance": "medium",
                },
                {
                    "beat_id": "beat_03",
                    "beat_type": "resolution",
                    "description": "Story concludes",
                    "timestamp_estimate": 12,
                    "importance": "high",
                },
            ]
    ...
    def _generate_cinematic_structure(
        self, scenes: List[Dict], characters: List[Dict]
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "character_screen_time": self._calculate_character_screen_time(
                scenes, characters
            ),
    ...
    def _create_default_character(
        self, character_type: str, character_id: int
    ) -> Dict[str, Any]:
    ...
    def _create_character_from_name(
        self, name: str, character_id: int
    ) -> Dict[str, Any]:
    ...
    def _extract_key_actions(self, paragraph: str) -> List[str]:
        ...
        action_verbs = re.findall(
            r"\b(?:walks?|runs?|talks?|looks?|moves?|enters?|exits?|sits?|stands?)\b",
            paragraph,
            re.IGNORECASE,
        )
    ...
    def _suggest_camera_language(self, paragraph: str) -> Dict[str, str]:
        ...
        if any(
            word in text_lower
            for word in ["wide", "landscape", "establishing", "overview"]
        ):
            shot_type = "LS"
        ...
        return {"shot_type": shot_type, "angle": angle, "movement": movement}
    ...
    def _generate_coherence_requirements(
    ...
    def _calculate_character_screen_time(
        self, scenes: List[Dict], characters: List[Dict]
    ) -> Dict[str, int]:
    ...
    def _update_project_with_script(
        self, project_path: Path, script_metadata: Dict[str, Any]
    ) -> None:
        ...
        project_data["script_metadata"] = {
            ...
            "total_characters": script_metadata["processing_metadata"][
                "total_characters"
            ],
            "estimated_duration": script_metadata["processing_metadata"][
                "estimated_duration_seconds"
            ],
            "complexity_score": script_metadata["processing_metadata"][
                "complexity_score"
            ],
        }
