...
const PlanEditor: React.FC<PlanEditorProps> = ({ projectId, onSave }) => {
  ...
  const addNewEntry = () => {
    ...
    const newEntry: VideoPlanEntry = {
      shot_id: `shot_${videoPlan.video_entries.length + 1:02d}`,
  ...
  return (
    <div className="plan-editor bg-gray-900 text-white p-6 rounded-lg">
      ...
      <div className="bg-gray-800 p-4 rounded-lg mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          ...
          <div>
            ...
            <span className="ml-2 font-bold text-green-400">{videoPlan.total_duration.toFixed(1)}s</span>
          </div>
          <div>
      ...
      <div className="space-y-4">
        {videoPlan.video_entries.map((entry, index) => (
            ...
            {editingEntry === entry.shot_id ? (
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm text-gray-400 mb-1">Mouvement Caméra</label>
                    <select
