...
def log_grid_generation(
    project_path: Path, grid_spec: str, grid_path: str, panel_count: int, cell_size: int
) -> bool:
    """
...
def log_project_export(
    project_path: Path, export_format: str, export_location: str, file_count: int
) -> bool:
    """
    ...
    return log_pipeline_action(
        ...
        parameters={"format": export_format, "file_count": str(file_count)},
    ...
    try:
        ...
        for asset_path in asset_paths:
            ...
            description = _generate_asset_description(
                asset_path_obj, asset_type, generation_context
            )
...
def _generate_asset_description(
    asset_path: Path, asset_type: str, context: Optional[Dict[str, Any]]
) -> str:
    """
