...
def get_config_path(
    project_path: Optional[str] = None, global_config: bool = False
) -> Path:
...
def load_profile_config(
    profile_name: str, project_path: Optional[str] = None
) -> Dict[str, Any]:
    """
...
def create_default_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "profiles": {
            "default": {"description": "Default production configuration"},
            "development": {
                "description": "Development configuration with mock mode",
                "general": {"mock_mode": True},
                "logging": {"level": "DEBUG"},
            },
            "production": {
                "description": "Production configuration with optimizations",
                "general": {"mock_mode": False, "max_workers": 8},
