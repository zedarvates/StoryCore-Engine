...
class GridHandler(BaseHandler):
    ...
    def setup_parser(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument("--out", help="Output path for grid image (optional)")
    ...
    def execute(self, args: argparse.Namespace) -> int:
        ...
        try:
            ...
            grid_path = generator.generate_grid(
                str(project_path), args.grid, args.out, args.cell_size, **backend_config
            )
            ...
            print(
                f"  Panels: assets/images/panels/panel_01.ppm ... panel_{total_panels:02d}.ppm"
            )
