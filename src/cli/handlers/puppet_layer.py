...
class PuppetLayerHandler(BaseHandler):
    ...
    def setup_parser(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            "--character", help="Character ID to generate puppet layers for"
        )
    ...
    def execute(self, args: argparse.Namespace) -> int:
        ...
        try:
            ...
            if args.all:
                result = engine.generate_all_puppet_layers(
                    project_path, layers=args.layers
                )
                characters_processed = result["characters_processed"]
            else:
                result = engine.generate_puppet_layers(
                    project_path, args.character, layers=args.layers
                )
            ...
            print("  Updated project.json with puppet layer metadata")
