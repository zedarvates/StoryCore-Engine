...
ASSETS = [
    (
        ...
        "Professional logo for StoryCore text, modern typography, minimal style",
        1280,
        360,
    ),
    (
        "storycore_logo_square",
        "Square app icon with SC monogram, modern minimal design",
        512,
        512,
    ),
    (
        "storycore_panel_placeholder",
        "Storyboard panel placeholder, neutral gray background, grid",
        854,
        480,
    ),
    (
        "storycore_loading_state",
        "Loading spinner icon, clean minimal UI design",
        256,
        256,
    ),
    ...
    (
        ...
        "Character design template, generic figure outline",
        512,
        768,
    ),
    (
        "storycore_banner_featured",
        "Featured banner, dark gradient background",
        1280,
        360,
    ),
]
...
def create_sdxl_workflow(name, prompt, width, height, seed=None):
    ...
    return {
        ...
        "7": {
            ...
            "inputs": {
                "model_name": "jina_clip_v2_bf16.safetensors",
