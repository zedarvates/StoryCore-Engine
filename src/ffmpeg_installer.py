...
class FFmpegInstaller:
    ...
    def install_ffmpeg_portable(self) -> Tuple[bool, str]:
        ...
        try:
            if self.platform_type == "windows":
                ...
                return (
                    False,
                    f"Automatic installation not supported for {self.platform_type}",
                )
                    ...
                    try:
                        ...
                        if result.returncode == 0:
                            ...
                            if shutil.which("ffmpeg"):
                                ...
                                return (
                                    True,
                                    f"FFmpeg installed successfully using {pm_name}",
                                )
    ...
    def _install_ffmpeg_macos(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            return (
                False,
                "No package manager found. Please install Homebrew or MacPorts first.",
            )
...
def main():
    ...
    parser.add_argument(
        "--install", action="store_true", help="Attempt automatic installation"
    )
    parser.add_argument(
        "--check", action="store_true", help="Check FFmpeg availability"
    )
    parser.add_argument(
        "--instructions", action="store_true", help="Show installation instructions"
    )
    ...
    if args.install:
        ...
        if success:
            ...
            if is_available:
                ...
                print(
                    "Verification: ✗ Installation completed but FFmpeg not accessible"
                )
