...
ASSETS = [
    (
        "storycore_logo_horizontal",
        "Professional logo design for StoryCore text, modern typography, clean minimal style, dark background with gradient accent",
        1024,
        256,
    ),
    (
        "storycore_logo_square",
        "Square app icon design SC monogram logo, modern minimal style, dark background with blue-purple gradient",
        512,
        512,
    ),
    (
        "storycore_panel_placeholder",
        "Storyboard panel placeholder, neutral gray gradient background, subtle grid overlay, professional comic panel template",
        768,
        432,
    ),
    (
        "storycore_loading_state",
        "Animated loading spinner placeholder, circular loading animation mockup, professional UI loading indicator, clean minimal design",
        256,
        256,
    ),
    (
        "storycore_error_state",
        "Error state illustration, warning triangle icon, professional UI error graphic, clean minimal design, red-orange accent",
        400,
        300,
    ),
    (
        "storycore_character_template",
        "Character design template for storyboard, generic figure outline, front view, clean line art style, minimal details",
        512,
        768,
    ),
    (
        "storycore_banner_featured",
        "Featured content banner design, horizontal layout, dark gradient background, modern tech aesthetic, clean minimal style",
        1200,
        400,
    ),
]
