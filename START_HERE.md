# 🚀 START HERE - StoryCore Engine

**Welcome!** You are in the right place to get started with StoryCore Engine.

---

## 🎯 Who Are You?

Choose your profile to access the appropriate documentation:
...
**Objective**: Quick access to technical information
...
npm run build
```
📖 See: [QUICK_REFERENCE.md - Building](QUICK_REFERENCE.md#building)
...
```
📖 See: [QUICK_REFERENCE.md - Packaging](QUICK_REFERENCE.md#packaging)
...
1. **Follow GETTING_STARTED_DEV.md** step by step
2. **Test the build** before starting to code
3. **Explore the project structure** progressively
...
### Support
1. Search in [GitHub Issues](https://github.com/zedarvates/StoryCore-Engine/issues)
2. Ask a question in [Discussions](https://github.com/zedarvates/StoryCore-Engine/discussions)
3. Contact the team
...
Choose your profile above and follow the recommended links.
