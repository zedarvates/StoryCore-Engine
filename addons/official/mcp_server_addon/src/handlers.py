...
class MCPHandler:
    ...
    def __init__(
        self, mcp_client: MCPClient, validator: MCPValidator, logger: logging.Logger
    ):
        """
    ...
    async def handle_message(self, message: str) -> str:
        ...
        try:
            ...
            return self._create_error_response(-32603, "Internal Error", None)
    ...
    async def _handle_request(self, request_data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            # Créer la réponse
            response_data = {"jsonrpc": "2.0", "result": result.data, "id": request_id}
    ...
    async def _handle_notification(self, notification_data: Dict[str, Any]) -> None:
        ...
        if method in self.handlers:
            try:
                ...
                self.logger.error(
                    f"Erreur dans le handler de notification {method}: {e}"
                )
    ...
    def _create_error_response(
        self, code: int, message: str, request_id: Optional[str]
    ) -> str:
        """
        ...
        """
        error_data = {"jsonrpc": "2.0", "error": {"code": code, "message": message}}
    ...
    async def _handle_initialize(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "serverInfo": {"name": "StoryCore MCP Server", "version": "1.0.0"},
        }
