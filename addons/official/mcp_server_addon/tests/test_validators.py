...
from src.validators import MCPValidator, ValidationResult, SecurityCheck
...
class TestMCPValidator:
    ...
    def test_validate_message_too_large(self, validator):
        ...
        large_message = '{"jsonrpc": "2.0", "method": "test", "id": "test"}' * (
            1024 * 1024 + 1
        )
...
class TestValidationResult:
    ...
    def test_validation_result_creation(self):
        ...
        result = ValidationResult(
            is_valid=True, errors=[], warnings=[], info=[], score=100.0
        )
...
class TestSecurityCheck:
    ...
    def test_security_check_passed(self):
        ...
        check = SecurityCheck(passed=True, issues=[], recommendations=[])
