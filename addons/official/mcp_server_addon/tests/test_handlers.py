...
class TestMCPHandler:
    ...
    async def test_handle_read_resource_success(self, handler):
        ...
        # Mock de Path
        with (
            patch("src.handlers.Path") as mock_path,
    ...
    def test_get_registered_handlers(self, handler):
        ...
        handler.handlers = {"method1": Mock(), "method2": Mock()}
...
class TestHandlerResult:
    ...
    def test_handler_result_creation(self):
        ...
        result = HandlerResult(
            success=True, data={"result": "success"}, metadata={"processing_time": 1.5}
        )
    ...
    def test_handler_result_failure(self):
        ...
        result = HandlerResult(success=False, error="Handler failed")
