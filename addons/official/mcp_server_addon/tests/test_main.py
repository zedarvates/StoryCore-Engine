...
class TestMCPServerAddon:
    ...
    def mock_context(self):
        ...
        return {
            ...
            "metadata": {"server_config": {"timeout": 10, "max_connections": 5}},
        }
    ...
    async def test_start_success(self, addon):
        ...
        addon.hook_manager.execute_hook.assert_called_once_with(
            "addon_enabled", addon.addon_name
        )
    ...
    async def test_stop_success(self, addon):
        ...
        addon.hook_manager.execute_hook.assert_called_once_with(
            "addon_disabled", addon.addon_name
        )
    ...
    async def test_process_message_valid(self, addon):
        ...
        # Mock du handler
        addon.mcp_handler = AsyncMock()
        addon.mcp_handler.handle_message = AsyncMock(
    ...
    async def test_cleanup(self, addon):
        ...
        addon.hook_manager.unregister_all_addon_hooks.assert_called_once_with(
            addon.addon_name
        )
