...
class StoryCoreKritaExtension(Extension):
    ...
    def import_storyboard(self):
        ...
        try:
            ...
            if not shots:
                QMessageBox.warning(
                    None, "Import Error", "No shots found in the selected file."
                )
                return
            ...
            if not doc:
                ...
                doc = self.krita.createDocument(
                    1920, 1080, "StoryCore Storyboard", "RGBA", "U8", "", 24.0
                )
            ...
            QMessageBox.information(
                None, "Import Success", f"Imported {len(shots)} shots as layers."
            )

        except Exception as e:
            QMessageBox.critical(
                None, "Import Error", f"Failed to import storyboard: {str(e)}"
            )
