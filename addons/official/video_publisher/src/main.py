...
class PublisherService:
        ...
        self.platforms = [
            {
                ...
                "name": "YouTube Shorts",
                "status": "connected",
                "username": "@StoryCoreGen",
            },
            {
                "id": "tiktok",
                "name": "TikTok",
                "status": "connected",
                "username": "storycore_ai",
            },
            {
                "id": "instagram_reels",
    ...
    async def generate_ai_metadata(
        self, req: MetadataGenerationRequest
        ...
        if req.context:
            base_title = (
                req.context[:30] + "..." if len(req.context) > 30 else req.context
            )
        ...
        results["youtube_shorts"] = PlatformMetadata(
            ...
            description="Check out this amazing story created with StoryCore AI! \n\n#storycore #ai #filmmaking #shorts",
        ...
        results["tiktok"] = PlatformMetadata(
            ...
            description="AI Storytelling is here! 🤖✨ \n\n#fyp #storytime #aiart #storycore",
        ...
        results["instagram_reels"] = PlatformMetadata(
            ...
            description="Crafting digital worlds with StoryCore. 🎬✨ \n.\n.\n#reels #digitalart #aifilm #storycore #creativity",
        ...
        results["x_twitter"] = PlatformMetadata(
            ...
            description="The future of automated storytelling is here. What do you think of this result? 🧵👇",
