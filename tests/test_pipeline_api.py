...
class TestPipelineExecution:
    ...
    def test_execute_pipeline_invalid_stage(
        self, pipeline_handler, temp_dir, request_context
    ):
    ...
    def test_pause_resume_cancel(self, pipeline_handler, temp_dir, request_context):
        ...
        resume_response = pipeline_handler.resume_pipeline(
            resume_params, request_context
        )
        ...
        cancel_response = pipeline_handler.cancel_pipeline(
            cancel_params, request_context
        )
...
class TestCheckpointManagement:
    ...
    def test_create_checkpoint(self, pipeline_handler, temp_dir, request_context):
        ...
        response = pipeline_handler.create_checkpoint(
            checkpoint_params, request_context
        )
    ...
    def test_restore_checkpoint(self, pipeline_handler, temp_dir, request_context):
        ...
        create_response = pipeline_handler.create_checkpoint(
            checkpoint_params, request_context
        )
