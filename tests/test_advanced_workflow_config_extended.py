...
class TestConfigurationManager:
    ...
    def test_create_default_configuration(self):
        ...
        dev_config = self.manager.create_default_configuration(
        ...
        prod_config = self.manager.create_default_configuration(
    ...
    def test_save_and_load_configuration(self):
        ...
        original_config = self.manager.create_default_configuration(
            EnvironmentType.DEVELOPMENT
        )
    ...
    def test_configuration_validation_levels(self):
        ...
        with pytest.raises(ConfigurationError):
            self.manager.load_configuration(
                config_path=config_path, validation_level=ValidationLevel.STRICT
            )

        # Test lenient validation (should succeed with warnings)
        loaded_config = self.manager.load_configuration(
            config_path=config_path, validation_level=ValidationLevel.LENIENT
        )
    ...
    def test_json_format_support(self):
        ...
        self.manager.save_configuration(config, json_path, ConfigurationFormat.JSON)
...
class TestConfigurationIntegration:
    ...
    def test_configuration_migration_workflow(self):
        ...
        old_config_data = {
            ...
            "performance_config": {"max_batch_size": 2, "enable_mixed_precision": True},
        }
