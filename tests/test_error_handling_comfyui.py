...
class TestErrorCategorizer:
    ...
    def test_categorize_connection_error(self):
        ...
        categorized = ErrorCategorizer.categorize_error(
            error, context={"url": "localhost:8000"}
        )
    ...
    def test_categorize_model_error(self):
        ...
        categorized = ErrorCategorizer.categorize_error(
            error, context={"model_name": "FLUX Dev"}
        )
    ...
    def test_categorize_workflow_error(self):
        ...
        categorized = ErrorCategorizer.categorize_error(
            error,
            context={"workflow_name": "flux_basic", "missing_node": "FluxSampler"},
        )
    ...
    def test_categorize_generation_error(self):
        ...
        categorized = ErrorCategorizer.categorize_error(
            error, context={"shot_id": "shot_001"}
        )
...
class TestRetryManager:
    ...
    def test_with_retry_success_after_failures(self):
        ...
        mock_func = Mock(
            side_effect=[RuntimeError("Fail 1"), RuntimeError("Fail 2"), "success"]
        )
...
class TestErrorLogger:
    ...
    def test_create_error_logger(self, tmp_path):
        ...
        error_logger = ErrorLogger(log_dir=log_dir, max_log_size_mb=1, max_log_files=3)
    ...
    def test_log_error_with_additional_context(self, tmp_path):
        ...
        error_logger.log_error(
            error, additional_context={"user": "test_user", "session": "abc123"}
        )
    ...
    def test_get_recent_errors_with_category_filter(self, tmp_path):
        ...
        connection_errors = error_logger.get_recent_errors(
            count=10, category=ErrorCategory.CONNECTION
        )
...
class TestErrorHandlingIntegration:
    ...
    def test_complete_error_handling_flow(self, tmp_path):
        ...
        # Use retry manager
        try:
            result = retry_mgr.with_retry(connect_to_comfyui, "connect_operation")
            assert result == "connected"
        except Exception as e:
            # Categorize and log error
            categorized = ErrorCategorizer.categorize_error(
                e, context={"url": "localhost:8000"}
            )
    ...
    def test_error_recovery_guidance(self):
        ...
        categorized = ErrorCategorizer.categorize_error(
            model_error, context={"model_name": "FLUX Dev"}
        )
        ...
        categorized = ErrorCategorizer.categorize_error(
            workflow_error, context={"missing_node": "FluxSampler"}
        )
