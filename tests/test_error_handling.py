...
class TestCircuitBreaker:
    ...
    def test_circuit_closes_after_successes(self):
        ...
        breaker = CircuitBreaker(
            failure_threshold=2, success_threshold=2, timeout=0.1, window_size=10.0
        )
    ...
    def test_circuit_reopens_on_failure_in_half_open(self):
        ...
        breaker = CircuitBreaker(failure_threshold=2, timeout=0.1, window_size=10.0)
...
class TestErrorLogger:
    ...
    def test_log_error_with_context(self, mock_logger):
        ...
        error_data = ErrorLogger.log_error(error, additional_context=context)
