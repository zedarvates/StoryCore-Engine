...
class TestCharacterNameGenerator:
    ...
    def test_fantasy_name_generation(self, generator):
        ...
        name = generator.generate_name(
            culture="fantasy", genre="fantasy", archetype_role="hero"
        )
    ...
    def test_scifi_name_generation(self, generator):
        ...
        name = generator.generate_name(
            culture="western", genre="sci-fi", archetype_role="hero"
        )
    ...
    def test_modern_name_generation(self, generator):
        ...
        name = generator.generate_name(
            culture="western", genre="modern", archetype_role="ally"
        )
    ...
    def test_cultural_context_western(self, generator):
        ...
        name = generator.generate_name(
            culture="western", genre="modern", archetype_role="hero"
        )
    ...
    def test_cultural_context_fantasy(self, generator):
        ...
        name = generator.generate_name(
            culture="fantasy", genre="fantasy", archetype_role="mentor"
        )
    ...
    def test_archetype_hero_naming(self, generator):
        ...
        name = generator.generate_name(
            culture="western", genre="fantasy", archetype_role="hero"
        )
    ...
    def test_archetype_villain_naming(self, generator):
        ...
        name = generator.generate_name(
            culture="western", genre="fantasy", archetype_role="villain"
        )
    ...
    def test_archetype_mentor_naming(self, generator):
        ...
        name = generator.generate_name(
            culture="western", genre="fantasy", archetype_role="mentor"
        )
        ...
        for _ in range(10):
            ...
            for char in name.lower():
                if char not in "aeiouy":
                    consonant_count += 1
                    assert consonant_count <= 3, (
                        f"Too many consecutive consonants in {name}"
                    )
                else:
                    consonant_count = 0
