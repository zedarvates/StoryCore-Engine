...
class TestStoryGenerationE2E(unittest.TestCase):
    ...
    def test_workflow_with_manual_story_fallback(self):
        ...
        with patch("src.wizard.story_generator.generate_story") as mock_generate:
            ...
            rejected_story = Story(
                ...
                acts=[
                    ...
                    Act(
                        ActType.RESOLUTION, "Resolution", "Resolution description", 25.0
                    ),
                ],
        ...
        self.assertEqual(
            wizard_state.story_content,
            "This is a manually entered story about action and adventure.",
        )
    ...
    def test_story_generation_performance(self):
        ...
        self.orchestrator.input_handler.prompt_confirm.side_effect = [True, True]
        ...
        self.assertLess(
            generation_time,
            5.0,
            f"Story generation took {generation_time:.2f} seconds, expected < 5.0",
        )
