...
class TestCLIVideoIntegration:
    ...
    def temp_project(self):
        ...
        project_data = {
            ...
            "capabilities": {"video_generation": True, "image_generation": True},
            "generation_status": {"images": "done", "video": "pending"},
        }
    ...
    def video_config_file(self, temp_project):
        ...
        config_data = {
            "output": {"frame_rate": 24, "resolution": [1920, 1080], "format": "png"},
            "interpolation": {
            ...
            "camera": {"enable_motion_blur": True, "motion_blur_strength": 0.5},
            "performance": {
