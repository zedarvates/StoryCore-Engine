...
class TestNewBieImageIntegration(unittest.TestCase):
    ...
    def test_character_creation_from_dict(self):
        ...
        character = self.integration.create_character_from_dict(
            self.test_character_data
        )
    ...
    def test_image_generation(self):
        ...
        with patch.object(self.integration, "_mock_generate_image") as mock_gen:
            ...
            result = self.integration.generate_image(
                prompt, character, ImageQuality.HIGH
            )
    ...
    def test_image_generation_custom_config(self):
        ...
        prompt = "test prompt"
        custom_config = {"steps": 50, "cfg_scale": 9.0, "seed": 12345}

        with patch.object(self.integration, "_mock_generate_image") as mock_gen:
            mock_gen.return_value = "test_image.png"

            result = self.integration.generate_image(
                prompt, character, custom_config=custom_config
            )
    ...
    def test_quality_score_calculation(self):
        ...
        simple_score = self.integration._calculate_quality_score(
            "test.png", simple_prompt
        )
        complex_score = self.integration._calculate_quality_score(
            "test.png", complex_prompt
        )
    ...
    def test_consistency_check_insufficient_images(self):
        ...
        result = self.integration.check_character_consistency(
    ...
    def test_character_library_export(self):
        ...
        self.integration.create_character_from_dict(self.test_character_data)

        character2_data = self.test_character_data.copy()
        character2_data["name"] = "SecondCharacter"
        character2_data["hair_color"] = "red"
        self.integration.create_character_from_dict(character2_data)
