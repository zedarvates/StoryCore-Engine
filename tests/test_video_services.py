...
from backend.gpu_service import GPUService, GPUEncoder, GPUDecode, GPUConfig
...
class TestTransitionsService:
    ...
    def test_build_cut_transition(self):
        ...
        cmd = self.service.build_transition_command(
            "a.mp4", "b.mp4", TSTransitionType.CUT, "out.mp4", TransitionConfig()
        )
    ...
    def test_build_dissolve_transition(self):
        ...
        cmd = self.service.build_transition_command(
            "a.mp4", "b.mp4", TSTransitionType.DISSOLVE, "out.mp4", config
        )
    ...
    def test_build_fade_black_transition(self):
        ...
        cmd = self.service.build_transition_command(
            "a.mp4", "b.mp4", TSTransitionType.FADE_BLACK, "out.mp4", config
        )
    ...
    def test_build_wipe_transition(self):
        ...
        cmd = self.service.build_transition_command(
            "a.mp4", "b.mp4", TSTransitionType.WIPE_LEFT, "out.mp4", config
        )
    ...
    def test_build_zoom_transition(self):
        ...
        cmd = self.service.build_transition_command(
            "a.mp4", "b.mp4", TSTransitionType.ZOOM_IN, "out.mp4", config
        )
    ...
    def test_transition_duration_range_fade(self):
        ...
        range_black = self.service.get_transition_duration_range(
            TSTransitionType.FADE_BLACK
        )
        range_white = self.service.get_transition_duration_range(
            TSTransitionType.FADE_WHITE
        )
    ...
    def test_validate_transition_valid(self):
        ...
        result = self.service.validate_transition(TSTransitionType.DISSOLVE, 1.5)
...
class TestGPUService:
    ...
    def test_build_gpu_encode_command_structure(self):
        ...
        cmd = self.service.build_gpu_encode_command("in.mp4", "out.mp4")
...
class TestTimelineTrack:
    ...
    def test_track_creation(self):
        ...
        track = TimelineTrack(id="track-1", name="Video Track", type=ClipType.VIDEO)
...
class TestTimeline:
    ...
    def test_timeline_creation(self):
        """Test création d'un timeline"""
        timeline = Timeline(id="timeline-1", name="My Timeline")
