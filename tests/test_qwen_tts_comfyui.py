...
from qwen_tts_comfyui.workflows.custom_voice import get_voice_instruction
from qwen_tts_comfyui.workflows.voice_clone import get_clone_preset
from qwen_tts_comfyui.workflows.training import (
    get_training_preset,
...
class TestQwenTTSModelConfig:
    ...
    def test_custom_values(self):
        ...
        config = QwenTTSModelConfig(
            model_choice="0.6B", device="cpu", precision="fp32", attention="sdpa"
        )
...
class TestQwenTTSConfig:
    ...
    def test_nested_config_from_dict(self):
        ...
        config = QwenTTSConfig(
            model={"model_choice": "0.6B"}, generation={"temperature": 0.8}
        )
...
class TestCustomVoiceWorkflowBuilder:
    ...
    def test_build_basic_workflow(self):
        ...
        workflow = builder.build(text="Hello, world!", speaker="Ryan")
    ...
    def test_build_with_instruct(self):
        ...
        workflow = builder.build_with_instruct(
            text="Test text", instruct="Speak slowly", speaker="Emily"
        )
...
class TestVoiceCloneWorkflowBuilder:
    ...
    def test_build_basic_workflow(self):
        ...
        workflow = builder.build(
            target_text="Hello, cloned voice!", ref_audio="reference.wav"
        )
    ...
    def test_build_with_reference_audio(self):
        ...
        workflow = builder.build_with_reference_audio(
            target_text="Test", ref_audio_path="ref.wav", ref_text="Reference text"
        )
    ...
    def test_build_quick_clone(self):
        ...
        workflow = builder.build_quick_clone(
            target_text="Test", ref_audio_path="ref.wav"
        )
...
class TestAudioResult:
    ...
    def test_failed_result(self):
        ...
        result = AudioResult(success=False, error_message="Generation failed")
    ...
    def test_get_info(self):
        ...
        result = AudioResult(success=True, duration=3.5, speaker="Emily")
...
class TestTrainingResult:
    ...
    def test_get_latest_checkpoint(self):
        ...
        result = TrainingResult(
            success=True, checkpoints=["/ckpt/epoch-1", "/ckpt/epoch-2"]
        )
...
class TestPresetsAndInstructions:
    ...
    def test_estimate_training_time(self):
        ...
        estimate = estimate_training_time(
            num_audio_files=100, avg_audio_duration=10.0, preset="standard"
        )
...
class TestQwenTTSComfyUIClient:
    ...
    def test_create_client_factory(self):
        ...
        client = create_client(
            comfyui_url="http://test:8188", model_choice="0.6B", device="cpu"
        )
