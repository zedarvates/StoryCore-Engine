...
def audio_keyframe_strategy(draw):
    ...
    return AudioKeyframe(
        ...
        volume_db=draw(
            st.floats(
                min_value=-100.0, max_value=30.0, allow_nan=False, allow_infinity=False
            )
        ),
