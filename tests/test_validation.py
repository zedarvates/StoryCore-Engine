...
class TestClaimValidation:
    ...
    def test_empty_text(self):
        ...
        claim_data = {"id": "claim-123", "text": "", "position": [0, 0]}
        result = validate_claim(claim_data)
        assert not result.is_valid
        assert any(e.field == "text" for e in result.errors)
...
class TestScientificAuditInputValidation:
    ...
    def test_valid_input(self):
        ...
        input_data = {"content": "Water boils at 100 degrees Celsius at sea level."}
    ...
    def test_invalid_domain_hint(self):
        ...
        input_data = {"content": "Some text", "domain_hint": "invalid_domain"}
        result = validate_scientific_audit_input(input_data)
        assert not result.is_valid
    ...
    def test_confidence_threshold_out_of_range(self):
        ...
        input_data = {"content": "Some text", "confidence_threshold": 150}
        result = validate_scientific_audit_input(input_data)
        assert not result.is_valid
...
class TestAntiFakeVideoInputValidation:
    ...
    def test_valid_input(self):
        """Test validation passes for valid input."""
        input_data = {"transcript": "This is a video transcript with some content."}
    ...
    def test_invalid_timestamps_type(self):
        ...
        input_data = {"transcript": "Some transcript", "timestamps": "not-an-array"}
        result = validate_antifake_video_input(input_data)
        assert not result.is_valid
...
class TestFactCheckerCommandValidation:
    ...
    def test_valid_command(self):
        ...
        command_data = {"input": "Water boils at 100 degrees Celsius.", "mode": "text"}
    ...
    def test_invalid_mode(self):
        ...
        command_data = {"input": "Some text", "mode": "invalid_mode"}
        result = validate_fact_checker_command(command_data)
        assert not result.is_valid
    ...
    def test_invalid_detail_level(self):
        ...
        command_data = {"input": "Some text", "detail_level": "invalid_level"}
        result = validate_fact_checker_command(command_data)
        assert not result.is_valid
