...
class TestScreenshotValidation:
    ...
    def create_test_file(
        self, filename: str, size_mb: float = 1.0, magic_bytes: bytes = None
    ) -> str:
        """
    ...
    def test_valid_png_file(self):
        ...
        file_path = self.create_test_file(
            "test.png", size_mb=1.0, magic_bytes=png_magic
        )
    ...
    def test_valid_jpg_file(self):
        ...
        file_path = self.create_test_file(
            "test.jpg", size_mb=1.0, magic_bytes=jpg_magic
        )
    ...
    def test_valid_jpeg_file(self):
        ...
        file_path = self.create_test_file(
            "test.jpeg", size_mb=1.0, magic_bytes=jpeg_magic
        )
    ...
    def test_valid_gif_file(self):
        ...
        gif_magic = b"GIF89a"
        file_path = self.create_test_file(
            "test.gif", size_mb=1.0, magic_bytes=gif_magic
        )
    ...
    def test_file_at_max_size(self):
        ...
        png_magic = b"\x89PNG\r\n\x1a\n"
        file_path = self.create_test_file(
            "test.png", size_mb=5.0, magic_bytes=png_magic
        )
    ...
    def test_file_exceeds_max_size(self):
        ...
        png_magic = b"\x89PNG\r\n\x1a\n"
        file_path = self.create_test_file(
            "test.png", size_mb=6.0, magic_bytes=png_magic
        )
    ...
    def test_small_file_passes(self):
        ...
        png_magic = b"\x89PNG\r\n\x1a\n"
        file_path = self.create_test_file(
            "test.png", size_mb=0.5, magic_bytes=png_magic
        )
    ...
    def test_mismatched_extension_and_content(self):
        ...
        png_magic = b"\x89PNG\r\n\x1a\n"
        file_path = self.create_test_file(
            "test.jpg", size_mb=1.0, magic_bytes=png_magic
        )
    ...
    def test_invalid_image_content(self):
        ...
        file_path = self.create_test_file(
            "test.png", size_mb=1.0, magic_bytes=invalid_magic
        )
    ...
    def test_error_message_includes_file_size(self):
        ...
        png_magic = b"\x89PNG\r\n\x1a\n"
        file_path = self.create_test_file(
            "test.png", size_mb=7.5, magic_bytes=png_magic
        )
