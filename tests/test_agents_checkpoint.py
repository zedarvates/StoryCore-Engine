...
import pytest
from src.fact_checker import ScientificAuditAgent, AntiFakeVideoAgent, Configuration
...
class TestAntiFakeVideoAgentCheckpoint:
    ...
    def test_analysis_with_metadata(self):
        ...
        metadata = {"source": "test_video.mp4", "duration_seconds": 120}
    ...
    def test_manipulation_detection(self):
        ...
        assert (
            "emotional_manipulation" in signal_types or "narrative_bias" in signal_types
        )
...
class TestAgentIntegration:
    ...
    def test_agents_use_same_configuration(self):
        ...
        config = Configuration(confidence_threshold=75.0, timeout_seconds=120)
