...
def test_compare_command():
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py grid --project compare-test --grid 1x2 --cell-size 200"
    )
    if not success:
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py promote --project compare-test --scale 2"
    )
    if not success:
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py refine --project compare-test --mode unsharp --strength 0.5 --metrics"
    )
    if not success:
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py compare --project compare-test --panel 1 --mode side-by-side"
    )
    if not success:
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py compare --project compare-test --panel all --mode grid"
    )
    if not success:
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py compare --project compare-test --panel all --mode side-by-side"
    )
    if not success:
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py compare --project compare-test --panel 2 --out custom/compare"
    )
    if not success:
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py compare --project error-test --panel 1"
    )
    if success:
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py qa --project compare-test"
    )
    if not success:
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py init no-metrics-test"
    )
    if not success:
    ...
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py grid --project no-metrics-test --grid 1x2 --cell-size 200"
    )
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py promote --project no-metrics-test --scale 2"
    )
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py refine --project no-metrics-test --mode unsharp --strength 0.5"
    )  # No --metrics
    success, stdout, stderr = run_command(
        "python3 storycore_cli.py compare --project no-metrics-test --panel 1"
    )
