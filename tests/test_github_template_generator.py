...
class TestGitHubTemplateGenerator:
    ...
    def setup_method(self):
        ...
        self.sample_payload = {
            ...
            "module_context": {"active_module": "grid-generator", "module_state": {}},
            "user_input": {
    ...
    def test_format_issue_body_without_optional_fields(self):
        ...
        minimal_payload = {
            ...
            "user_input": {"description": "How do I use this feature?"},
            "diagnostics": {},
        }
    ...
    def test_generate_github_url_structure(self):
        ...
        assert url.startswith(
            "https://github.com/zedarvates/StoryCore-Engine/issues/new?"
        )
