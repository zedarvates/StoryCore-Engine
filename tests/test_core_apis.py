...
class TestDomainRouting:
    ...
    def test_classify_domain_physics(self):
        ...
        claim = Claim(
            id="1", text="The force equals mass times acceleration.", position=(0, 50)
        )
    ...
    def test_classify_domain_history(self):
        ...
        claim = Claim(id="1", text="World War II ended in 1945.", position=(0, 30))
    ...
    def test_classify_domains_batch(self):
        ...
        claims = [
            Claim(
                id="1", text="Force equals mass times acceleration.", position=(0, 40)
            ),
...
class TestEvidenceRetrieval:
    ...
    def test_retrieve_evidence(self):
        ...
        claim = Claim(
            id="1", text="Water boils at 100 degrees Celsius.", position=(0, 40)
        )
        sources = get_trusted_sources("physics")
    ...
    def test_retrieve_evidence_batch(self):
        ...
        evidence_lists = retrieve_evidence_batch(
            claims, sources, max_results_per_claim=3
        )
    ...
    def test_rank_evidence(self):
        ...
        ranked = rank_evidence(
            evidence_list, credibility_weight=0.5, relevance_weight=0.5
        )
        assert len(ranked) == 3
...
class TestIntegration:
    ...
    def test_complete_workflow(self):
        ...
        # 4. Retrieve evidence
        evidence_lists = retrieve_evidence_batch(
            claims, all_sources, max_results_per_claim=3
        )
