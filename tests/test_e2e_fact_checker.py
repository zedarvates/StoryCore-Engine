...
class TestE2ETextWorkflow:
    ...
    def test_text_with_file_input(self, tmp_path):
        ...
        # Act
        result = command.execute(input_data=test_file, mode="text", detail_level="full")
    ...
    def test_text_with_custom_threshold(self):
        ...
        # Act
        result = command.execute(
            input_data=text_input, mode="text", confidence_threshold=85
        )
    ...
    def test_text_with_summary_detail_level(self):
        ...
        # Act
        result = command.execute(
            input_data=text_input, mode="text", detail_level="summary"
        )
...
class TestE2EVideoWorkflow:
    ...
    def test_video_transcript_analysis(self):
        ...
        # Act
        result = command.execute(
            input_data=transcript, mode="video", detail_level="detailed"
        )
    ...
    def test_video_with_file_input(self, tmp_path):
        ...
        # Act
        result = command.execute(input_data=test_file, mode="video")
    ...
    def test_video_manipulation_detection(self):
        ...
        # Act
        result = command.execute(input_data=transcript, mode="video")
...
class TestE2EAutoDetection:
    ...
    def test_auto_detect_text(self):
        ...
        # Act
        result = command.execute(input_data=text_input, mode="auto")
    ...
    def test_auto_detect_video(self):
        ...
        # Act
        result = command.execute(input_data=transcript, mode="auto")
...
class TestE2EPipelineIntegration:
    ...
    async def test_pipeline_hook_execution(self):
        ...
        result = await integration.execute_hook(
            hook_stage="before_generate", content=content
        )
...
class TestE2EOutputFormats:
    ...
    def test_json_output_format(self):
        ...
        # Act
        result = command.execute(
            input_data=text_input, mode="text", output_format="json"
        )
    ...
    def test_markdown_output_format(self):
        ...
        # Act
        result = command.execute(
            input_data=text_input, mode="text", output_format="markdown"
        )
...
class TestE2EErrorHandling:
    ...
    def test_invalid_file_path_error(self):
        ...
        # Act
        result = command.execute(input_data=Path("/nonexistent/file.txt"), mode="text")
...
class TestE2EPerformance:
    ...
    def test_text_processing_performance(self):
        ...
        # Act
        start_time = time.time()
        result = command.execute(input_data=text_input, mode="text")
        execution_time = time.time() - start_time
...
class TestE2EIntegration:
    ...
    def test_complete_video_workflow_with_markdown(self, tmp_path):
        ...
        result = command.execute(
            input_data=transcript, mode="video", output_format="json"
        )
