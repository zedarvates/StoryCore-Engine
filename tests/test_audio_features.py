...
class TestAudioFeatures(unittest.TestCase):
    ...
    def test_noise_reduction(self):
        ...
        # Test noise gate
        gated = noise_reduction.apply_noise_gate(
            self.test_audio, threshold=0.01, ratio=2.0
        )
    ...
    def test_speed_changer(self):
        ...
        modified = speed_changer.change_speed_with_pitch(
            self.test_audio, speed_factor=1.2, pitch_factor=0.8
        )
    ...
    def test_voice_modification(self):
        ...
        modified = voice_mod.modify_voice(
            self.test_audio, pitch_factor=1.2, formant_factor=0.9
        )
