...
class TestComfyUIClient(unittest.TestCase):
    ...
    def test_parameter_injection(self):
        ...
        modified = self.client._inject_parameters(
            self.sample_workflow, 123, "test prompt"
        )
...
class TestIntegrationUtils(unittest.TestCase):
    def setUp(self):
        ...
        self.project_config = {"global_seed": 42, "target_resolution": "1024x768"}

    def test_parameter_injection(self):
        """Test StoryCore parameter injection"""
        modified = inject_storycore_parameters(
            self.sample_workflow, self.project_config
        )
...
class TestIntegrationScenarios(unittest.TestCase):
    ...
    def test_complete_workflow_execution(self, mock_get, mock_post):
        ...
        mock_post.return_value = Mock(
            status_code=200, json=lambda: {"prompt_id": "test_workflow_123"}
        )
