...
def test_personality_generation():
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        try:
            ...
            print(
                f"  Openness:           {personality.openness:.2f} (0=closed, 1=open)"
            )
            print(
                f"  Conscientiousness:  {personality.conscientiousness:.2f} (0=careless, 1=organized)"
            )
            print(
                f"  Extraversion:       {personality.extraversion:.2f} (0=introverted, 1=extraverted)"
            )
            print(
                f"  Agreeableness:      {personality.agreeableness:.2f} (0=competitive, 1=cooperative)"
            )
            print(
                f"  Neuroticism:        {personality.neuroticism:.2f} (0=stable, 1=anxious)"
            )
            ...
            contradictions = []
            if (
                "brave" in personality.primary_traits
                and "cowardly" in personality.flaws
            ):
            ...
            if not contradictions:
                ...
                coherence_checks.append(
                    f"✗ Contradictions found: {', '.join(contradictions)}"
                )
    ...
    print("✓ Enhanced personality generation with psychological models working")
    print("✓ Big Five trait modeling implemented")
    print("✓ Genre-specific modifiers applied")
    print("✓ Coherence validation active")
    print()
