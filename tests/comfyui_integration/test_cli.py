...
class TestArgumentParsing:
    ...
    def test_url_argument(self):
        ...
        with patch(
            "sys.argv", ["run_comfyui_tests.py", "--url", "http://localhost:8188"]
        ):
            args = parse_arguments()
    ...
    def test_output_dir_argument(self):
        ...
        with patch(
            "sys.argv", ["run_comfyui_tests.py", "--output-dir", "./my_results"]
        ):
            args = parse_arguments()
    ...
    def test_workflows_dir_argument(self):
        ...
        with patch(
            "sys.argv", ["run_comfyui_tests.py", "--workflows-dir", "./my_workflows"]
        ):
            args = parse_arguments()
...
class TestConfigurationFromArgs:
    ...
    def test_command_line_overrides_environment(self):
        ...
        env_vars = {"COMFYUI_URL": "http://env-url:8188", "COMFYUI_TIMEOUT": "900"}
