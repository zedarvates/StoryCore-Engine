...
"""
    ...
    def test_alert_thresholds(self):
        ...
        high_resources = {"cpu": 95.0, "memory": 90.0, "gpu": 98.0}
    ...
    def test_alert_sending(self):
        ...
        with (
            patch.object(self.monitor, "_send_email_alert") as mock_email,
    ...
    def test_alert_state_management(self):
        ...
        normal_resources = {"cpu": 40.0, "memory": 50.0, "gpu": 60.0}

        # Réinitialiser les alertes
        for alert_type in self.monitor.alert_states:
            if (
                self.monitor.alert_states[alert_type]
                and normal_resources[alert_type] < 90
            ):
    ...
    def test_monitoring_loop(self):
        ...
        with (
            patch.object(self.monitor, "check_system_resources") as mock_resources,
            ...
            patch.object(self.monitor, "send_alert"),
            patch("time.sleep"),
    ...
    def test_monitoring_configuration(self):
        ...
        self.assertEqual(
            self.monitor.monitoring_config["alerts"]["threshold_memory"], 85
        )
