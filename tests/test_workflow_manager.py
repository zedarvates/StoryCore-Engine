...
class TestWorkflowManagerInitialization:
    ...
    def test_initialization_creates_comfyui_directory(self, temp_dirs):
        ...
        # Create manager
        WorkflowManager(workflows_dir, comfyui_workflows_dir)
...
class TestCheckInstalledWorkflows:
    ...
    def test_check_installed_workflows_with_installed(
        self, workflow_manager, sample_workflow_data, temp_dirs
    ):
    ...
    def test_check_installed_workflows_version_match(
        self, workflow_manager, sample_workflow_data, temp_dirs
    ):
...
class TestGetWorkflowVersion:
    ...
    def test_get_version_with_metadata(
        self, workflow_manager, sample_workflow_data, temp_dirs
    ):
...
class TestCheckForUpdates:
    ...
    def test_check_updates_all_up_to_date(
        self, workflow_manager, sample_workflow_data, temp_dirs
    ):
...
class TestDeployWorkflow:
    ...
    def test_deploy_workflow_success(
        ...
        workflow_manager.workflow_registry[
...
class TestDeployAllWorkflows:
    ...
    def test_deploy_all_workflows_success(
        self, workflow_manager, sample_workflow_data, temp_dirs
    ):
    ...
    def test_deploy_all_workflows_partial_failure(
        self, workflow_manager, sample_workflow_data, temp_dirs
    ):
...
class TestValidateWorkflow:
    ...
    def test_validate_workflow_with_installed_nodes(
        self, workflow_manager, sample_workflow_data, temp_dirs
    ):
    ...
    def test_validate_workflow_missing_nodes(
        ...
        installed_nodes = [
            "KSampler"
        ]  # Missing CLIPTextEncode and CheckpointLoaderSimple
        result = workflow_manager.validate_workflow(workflow_path, installed_nodes)
...
class TestExtractRequiredNodes:
    ...
    def test_extract_nodes_alternative_format(self, workflow_manager):
        ...
        workflow_data = {"1": {"type": "KSampler"}, "2": {"type": "CLIPTextEncode"}}
...
class TestWorkflowValidationResult:
    ...
    def test_validation_result_creation(self):
        ...
        result = WorkflowValidationResult(valid=True, workflow_name="test_workflow")
