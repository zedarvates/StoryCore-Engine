...
def test_task_creation_and_status():
    ...
    try:
        ...
        task_id = task_manager.create_task(
            operation=sample_async_operation, params={"input": "test data"}
        )
...
def test_task_cancellation():
    ...
    try:
        # Create a task
        task_id = task_manager.create_task(operation=sample_async_operation, params={})
...
def test_task_status_endpoint():
    ...
    try:
        ...
        # Create a task
        task_id = task_manager.create_task(
            operation=sample_async_operation, params={"input": "api test"}
        )
...
def test_concurrent_tasks():
    ...
    try:
        ...
        for i in range(5):
            task_id = task_manager.create_task(
                operation=sample_async_operation, params={"input": f"task-{i}"}
            )
...
def test_task_manager_stats():
    ...
    try:
        ...
        for i in range(3):
            task_id = task_manager.create_task(
                operation=sample_async_operation, params={}
            )
            task_ids.append(task_id)
...
def test_task_cleanup():
    ...
    try:
        ...
        task_id = task_manager.create_task(
            operation=lambda params, task: {"result": "quick"}, params={}
        )
