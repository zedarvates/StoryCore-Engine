...
def test_task_timeout():
    ...
    try:
        ...
        task_id = task_manager.create_task(
            operation=slow_operation, params={}, timeout=1.0
        )
...
def test_task_timeout_with_partial_result():
    ...
    try:
        # Create a task with 1 second timeout
        task_id = task_manager.create_task(
            operation=operation_with_partial_result, params={}, timeout=1.0
        )
...
def test_task_completes_before_timeout():
    ...
    try:
        ...
        task_id = task_manager.create_task(
            operation=fast_operation, params={}, timeout=5.0
        )
...
def test_task_without_timeout():
    ...
    try:
        ...
        task_id = task_manager.create_task(
            operation=fast_operation, params={}, timeout=None
        )
