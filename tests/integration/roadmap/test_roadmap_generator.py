...
"""
        (sample_spec / "requirements.md").write_text(
...
"""
        ...
        requirements_updated = (sample_spec / "requirements.md").read_text(
            encoding="utf-8"
        )
        assert (
            "View in Public Roadmap" in requirements_updated
            or "roadmap" in requirements_updated.lower()
        )
...
"""
        (completed_spec / "requirements.md").write_text(
            requirements_content, encoding="utf-8"
        )
