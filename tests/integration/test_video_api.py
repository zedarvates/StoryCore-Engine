...
class TestVideoAssemble:
    ...
    def test_assemble_success(
        self, handler, request_context, temp_dir, mock_shot_files
    ):
    ...
    def test_assemble_invalid_resolution(
        self, handler, request_context, temp_dir, mock_shot_files
    ):
    ...
    def test_assemble_invalid_framerate(
        self, handler, request_context, temp_dir, mock_shot_files
    ):
...
class TestVideoTransitionAdd:
    ...
    def test_transition_add_success(
        self, handler, request_context, temp_dir, mock_video_file
    ):
    ...
    def test_transition_add_auto_output_path(
        self, handler, request_context, mock_video_file
    ):
    ...
    def test_transition_add_invalid_type(
        self, handler, request_context, mock_video_file
    ):
    ...
    def test_transition_add_negative_shot_index(
        self, handler, request_context, mock_video_file
    ):
    ...
    def test_transition_add_invalid_duration(
        self, handler, request_context, mock_video_file
    ):
...
class TestVideoEffectsApply:
    ...
    def test_effects_apply_success(
        self, handler, request_context, temp_dir, mock_video_file
    ):
    ...
    def test_effects_apply_single_effect(
        self, handler, request_context, mock_video_file
    ):
    ...
    def test_effects_apply_empty_effects(
        self, handler, request_context, mock_video_file
    ):
    ...
    def test_effects_apply_missing_effect_type(
        self, handler, request_context, mock_video_file
    ):
    ...
    def test_effects_apply_invalid_effect_type(
        self, handler, request_context, mock_video_file
    ):
...
class TestVideoRender:
    ...
    def test_render_different_qualities(
        self, handler, request_context, temp_dir, mock_video_file
    ):
    ...
    def test_render_invalid_resolution(
        self, handler, request_context, temp_dir, mock_video_file
    ):
    ...
    def test_render_invalid_framerate(
        self, handler, request_context, temp_dir, mock_video_file
    ):
...
class TestVideoPreview:
    ...
    def test_preview_invalid_resolution(
        self, handler, request_context, mock_video_file
    ):
...
class TestVideoEndpointIntegration:
    ...
    def test_endpoint_error_handling_consistency(self, handler, request_context):
        ...
        endpoints = [
            (
                "assemble",
                {"project_name": "test", "shots": [], "output_path": "/tmp/out.mp4"},
            ),
            (
                "transition_add",
                {
