...
class TestExportPackage:
    ...
    def test_export_package_invalid_compression(
        self, handler, request_context, temp_project
    ):
    ...
    def test_export_package_with_custom_output(
        self, handler, request_context, temp_project
    ):
...
class TestExportFormat:
    ...
    def test_format_conversion_unsupported_format(
        self, handler, request_context, temp_project
    ):
...
class TestExportMetadata:
    ...
    def test_metadata_generation_selective(
        self, handler, request_context, temp_project
    ):
    ...
    def test_metadata_generation_invalid_format(
        self, handler, request_context, temp_project
    ):
