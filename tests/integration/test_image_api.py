...
class TestGridCreation:
    ...
    def test_create_grid_with_invalid_format_fails(
        self, handler, context, temp_project
    ):
    ...
    def test_create_grid_with_invalid_cell_size_fails(
        self, handler, context, temp_project
    ):
...
class TestPanelPromotion:
    ...
    def test_promote_panel_with_invalid_scale_fails(
        self, handler, context, temp_project
    ):
    ...
    def test_promote_panel_with_invalid_method_fails(
        self, handler, context, temp_project
    ):
...
class TestImageRefinement:
    ...
    def test_refine_with_invalid_denoising_strength_fails(
        self, handler, context, temp_image
    ):
...
class TestStyleApplication:
    ...
    def test_apply_style_with_invalid_strength_fails(
        self, handler, context, temp_image
    ):
...
class TestBatchProcessing:
    ...
    def test_batch_process_with_invalid_operation_fails(
        self, handler, context, temp_image
    ):
