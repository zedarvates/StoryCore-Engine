...
class TestKnowledgeAddEndpoint:
    ...
    def test_knowledge_add_basic(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_add_with_auto_link(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_add_without_auto_link(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_add_missing_content(self, knowledge_handler, request_context):
        ...
        params = {"items": [{"knowledge_type": "fact"}]}
    ...
    def test_knowledge_add_invalid_knowledge_type(
        self, knowledge_handler, request_context
    ):
...
class TestKnowledgeSearchEndpoint:
    ...
    def test_knowledge_search_basic(
        ...
        # Add items first
        knowledge_handler.knowledge_add(
            {"items": sample_knowledge_items}, request_context
        )
    ...
    def test_knowledge_search_with_filters(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_search_semantic(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_search_non_semantic(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_search_with_confidence_filter(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_search_invalid_max_results(
        self, knowledge_handler, request_context
    ):
    ...
    def test_knowledge_search_invalid_knowledge_type(
        self, knowledge_handler, request_context
    ):
...
class TestKnowledgeUpdateEndpoint:
    ...
    def test_knowledge_update_basic(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_update_tags(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_update_knowledge_type(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_update_nonexistent_item(
        self, knowledge_handler, request_context
    ):
        """Test updating nonexistent knowledge item."""
        params = {"item_id": "nonexistent_id", "updates": {"content": "New content"}}
    ...
    def test_knowledge_update_empty_updates(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
        ...
        params = {"item_id": item_id, "updates": {}}
    ...
    def test_knowledge_update_invalid_knowledge_type(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
        ...
        params = {"item_id": item_id, "updates": {"knowledge_type": "invalid_type"}}
    ...
    def test_knowledge_update_invalid_confidence(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
        ...
        params = {"item_id": item_id, "updates": {"confidence": 1.5}}
...
class TestKnowledgeDeleteEndpoint:
    ...
    def test_knowledge_delete_basic(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_delete_single_item(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_delete_with_cascade(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_delete_nonexistent_items(
        self, knowledge_handler, request_context
    ):
    ...
    def test_knowledge_delete_missing_item_ids(
        self, knowledge_handler, request_context
    ):
    ...
    def test_knowledge_delete_invalid_item_ids_type(
        self, knowledge_handler, request_context
    ):
...
class TestKnowledgeGraphBuildEndpoint:
    ...
    def test_knowledge_graph_build_all_items(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_graph_build_specific_items(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_graph_build_without_relationships(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_graph_build_with_max_depth(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_graph_build_invalid_max_depth(
        self, knowledge_handler, request_context
    ):
    ...
    def test_knowledge_graph_build_invalid_item_ids_type(
        self, knowledge_handler, request_context
    ):
...
class TestKnowledgeVerifyEndpoint:
    ...
    def test_knowledge_verify_all_items(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_verify_specific_items(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_verify_contradictions_only(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_verify_completeness_only(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_verify_low_confidence_items(
        self, knowledge_handler, request_context
    ):
        ...
        knowledge_handler.knowledge_add(
            {"items": [low_confidence_item]}, request_context
        )
    ...
    def test_knowledge_verify_invalid_item_ids_type(
        self, knowledge_handler, request_context
    ):
...
class TestKnowledgeExportEndpoint:
    ...
    def test_knowledge_export_json(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_export_yaml(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_export_markdown(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_export_specific_items(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_export_without_relationships(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_export_without_metadata(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_knowledge_export_invalid_item_ids_type(
        self, knowledge_handler, request_context
    ):
...
class TestKnowledgeEndpointIntegration:
    ...
    def test_complete_crud_cycle(self, knowledge_handler, request_context):
        ...
        create_response = knowledge_handler.knowledge_add(
        ...
        search_response = knowledge_handler.knowledge_search(
            search_params, request_context
        )
        ...
        update_response = knowledge_handler.knowledge_update(
            update_params, request_context
        )
        ...
        delete_response = knowledge_handler.knowledge_delete(
            delete_params, request_context
        )
        assert delete_response.status == "success"
        assert delete_response.data["deleted_count"] == 1

        # Verify deletion
        search_response2 = knowledge_handler.knowledge_search(
            search_params, request_context
        )
    ...
    def test_add_search_export_flow(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
        ...
        # Search
        search_response = knowledge_handler.knowledge_search(
            {"query": "programming"}, request_context
        )
        assert search_response.status == "success"
        assert search_response.data["total_count"] > 0

        # Export
        export_response = knowledge_handler.knowledge_export(
            {"format": "json"}, request_context
        )
        assert export_response.status == "success"
        assert export_response.data["item_count"] == 3

    def test_add_build_graph_verify_flow(
        self, knowledge_handler, request_context, sample_knowledge_items
    ):
    ...
    def test_multiple_updates_same_item(self, knowledge_handler, request_context):
        ...
        update1 = knowledge_handler.knowledge_update(
            {"item_id": item_id, "updates": {"content": "Update 1"}}, request_context
        )
        ...
        update2 = knowledge_handler.knowledge_update(
            {"item_id": item_id, "updates": {"content": "Update 2", "confidence": 0.9}},
            request_context,
        )
    ...
    def test_search_after_delete(
        ...
        # Initial search
        search1 = knowledge_handler.knowledge_search(
            {"query": "programming"}, request_context
        )
        ...
        # Search again
        search2 = knowledge_handler.knowledge_search(
            {"query": "programming"}, request_context
        )
    ...
    def test_export_after_updates(
        ...
        knowledge_handler.knowledge_update(
            {"item_id": item_id, "updates": {"content": "Updated for export test"}},
            request_context,
        )
