...
from backend.automation_endpoints import router
from src.automation.dialogue_automation import DialogueAutomation
from src.automation.character_grid import CharacterGridAutomation
...
class TestDialogueEndpoints:
    ...
    def test_generate_dialogue(self, client, dialogue_automation):
        ...
        response = client.post(
            "/api/automation/dialogue/generate",
            json={
                "characters": [
                    {"character_id": "char_001", "name": "Hero", "archetype": "hero"}
                ],
                "context": {
    ...
    def test_get_dialogue_history(self, client, dialogue_automation):
        ...
        client.post(
            ...
            json={
                "characters": [
                    {"character_id": "test", "name": "Test", "archetype": "hero"}
                ],
                "context": {
                    "location": "Test",
                    "time_of_day": "day",
...
class TestCharacterGridEndpoints:
    ...
    def test_generate_character_grid(self, client, grid_automation):
        ...
        response = client.post(
            "/api/automation/character/grid/generate",
            json={
...
class TestPromptEnhancementEndpoints:
    ...
    def test_enhance_prompt_minimal(self, client):
        ...
        response = client.post(
            "/api/automation/prompt/enhance",
            json={"base_prompt": "A beautiful landscape"},
        )
    ...
    def test_enhance_prompt_empty(self, client):
        ...
        response = client.post(
            "/api/automation/prompt/enhance", json={"base_prompt": ""}
        )
        assert response.status_code == 422
...
class TestIntegrationScenarios:
    ...
    def test_full_grid_workflow(self, client, grid_automation):
        ...
        latest_response = client.get(
            "/api/automation/character/workflow_hero/latest-grid"
        )
