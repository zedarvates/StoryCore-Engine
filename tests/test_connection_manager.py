...
class TestComfyUIConfig:
    ...
    def test_custom_config(self):
        ...
        config = ComfyUIConfig(host="192.168.1.100", port=8188, timeout=60)
...
class TestConnectionManager:
    ...
    async def test_connect_success(self, manager):
        ...
        mock_response.json = AsyncMock(
            return_value={"system": {"version": "1.0.0", "queue_remaining": 0}}
        )
    ...
    async def test_check_health_success(self, manager):
        ...
        mock_response.status = 200
        mock_response.json = AsyncMock(
            return_value={"system": {"version": "1.0.0", "queue_remaining": 2}}
        )
