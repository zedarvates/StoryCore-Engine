...
class TestAPIOrchestrator:
    ...
    def test_orchestrator_initialization(self):
        ...
        assert not orchestrator._connected
    ...
    async def test_connection_http_fallback(self):
        ...
        with patch("aiohttp.ClientSession") as mock_session_class:
            ...
            assert not orchestrator._use_websocket  # Should fallback to HTTP
    ...
    async def test_execution_status_tracking(self):
        ...
        with patch("aiohttp.ClientSession") as mock_session_class:
            ...
            mock_response.status = 200
            mock_response.json = AsyncMock(
                return_value={"prompt_id": "test-prompt-456"}
            )
    ...
    def test_connection_properties(self):
        ...
        assert not orchestrator.is_websocket_connected
        ...
        assert orchestrator.is_websocket_connected
