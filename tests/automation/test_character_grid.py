...
class TestCharacterGridConfig:
    ...
    def test_default_config(self):
        ...
        config = CharacterGridConfig(
            character_id="char_001", character_name="Test Character"
        )
    ...
    def test_config_to_dict(self):
        ...
        config = CharacterGridConfig(
            character_id="test", character_name="Test", grid_size=GridSize.GRID_2X2
        )
...
class TestCharacterGridAutomation:
    ...
    def test_get_bundle_by_id(self, automation):
        ...
        config = CharacterGridConfig(
            character_id="test_char", character_name="Test Char"
        )
    ...
    def test_get_character_bundles(self, automation):
        ...
        for i in range(3):
            config = CharacterGridConfig(
                character_id="same_char", character_name="Same Char"
            )
    ...
    def test_get_latest_bundle(self, automation):
        ...
        config = CharacterGridConfig(
            character_id="latest_char", character_name="Latest Char"
        )
    ...
    def test_clear_history(self, automation):
        ...
        for i in range(3):
            config = CharacterGridConfig(
                character_id=f"char_{i}", character_name=f"Char {i}"
            )
            automation.generate_character_grid(config)
...
class TestCharacterGridBundle:
    ...
    def test_bundle_to_dict(self, tmp_path):
        ...
        config = CharacterGridConfig(
            character_id="bundle_test", character_name="Bundle Test"
        )

        automation = CharacterGridAutomation(
            base_output_dir=str(tmp_path / "characters")
        )
        bundle = automation.generate_character_grid(config)
