...
class TestDialogueAutomation:
    ...
    def test_generate_dialogue_single_character(self, automation):
        ...
        context = DialogueContext(
            location="Battlefield", time_of_day="dawn", situation="combat", mood="tense"
        )
    ...
    def test_get_dialogue_history(self, automation):
        ...
        for i in range(3):
            automation.generate_dialogue(
                characters=[character], context=context, num_lines=4
            )
    ...
    def test_get_scene_by_id(self, automation):
        ...
        context = DialogueContext(
            location="Tavern", time_of_day="evening", situation="rest", mood="joyful"
        )
    ...
    def test_clear_history(self, automation):
        ...
        # Générer un dialogue
        automation.generate_dialogue(characters=[character], context=context)
