...
import os
import tempfile
from src.prompt_generation.VideoPromptGenerator import (
...
class TestVideoPromptGenerator(unittest.TestCase):
    ...
    def test_save_and_load_template(self):
        ...
        try:
            ...
            self.assertEqual(
                loaded_template.name, "Génération de Prompt Vidéo Dynamique"
            )
    ...
    def test_get_template_info(self):
        ...
        self.assertEqual(
            ...
            "Template pour des vidéos avec des mouvements denses et une forte amplitude.",
        )
