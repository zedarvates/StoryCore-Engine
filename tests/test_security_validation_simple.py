...
class TestSecureDownloadManager:
    ...
    def test_validate_https_url(self):
        ...
        valid, error = manager.validate_download_source(
    ...
    def test_domain_whitelist(self):
        ...
        # Allowed domain
        valid, _ = manager.validate_download_source(
            "https://trusted.com/model.safetensors"
        )
        assert valid

        # Disallowed domain
        valid, error = manager.validate_download_source(
            "https://untrusted.com/model.safetensors"
        )
        assert not valid
    ...
    def test_download_history(self):
        ...
        asyncio.run(
            manager.download_model(
                "https://example.com/model.safetensors", Path("test.safetensors")
            )
        )
    ...
    def test_log_workflow_execution(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger.log_workflow_execution(
                "test_workflow", "test_user", {"param1": "value1"}
            )
    ...
    def test_log_security_event(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger.log_security_event(
                "intrusion_attempt", "test_user", "high", {"details": "test"}
            )
...
class TestSecurityValidationSystem:
    ...
    def test_validate_workflow_request_no_permission(self):
        ...
        valid, errors = system.validate_workflow_request(
            "test_user", "test_workflow", {"prompt": "test"}
        )
    ...
    def test_validate_workflow_request_invalid_prompt(self):
        ...
        valid, errors = system.validate_workflow_request(
            "test_user", "test_workflow", {"prompt": "'; DROP TABLE users;"}
        )
