...
def basic_capabilities():
    ...
    return SystemCapabilities(
        cpu_cores=8, ram_gb=16.0, gpu_available=True, disk_space_gb=500.0
    )
...
class TestQualityTierSelection:
    ...
    def test_high_end_system_gets_high_quality(self, manager):
        ...
        caps = SystemCapabilities(
            cpu_cores=16, ram_gb=32.0, gpu_available=True, disk_space_gb=1000.0
        )
    ...
    def test_mid_range_system_gets_standard(self, manager):
        ...
        caps = SystemCapabilities(
            cpu_cores=8, ram_gb=8.0, gpu_available=True, disk_space_gb=500.0
        )
    ...
    def test_low_end_system_gets_preview(self, manager):
        ...
        caps = SystemCapabilities(
            cpu_cores=4, ram_gb=4.0, gpu_available=False, disk_space_gb=100.0
        )
    ...
    def test_no_gpu_but_good_ram_gets_standard(self, manager):
        ...
        caps = SystemCapabilities(
            cpu_cores=8, ram_gb=16.0, gpu_available=False, disk_space_gb=500.0
        )
...
class TestSeedGeneration:
    ...
    def test_seeds_are_different(self, manager):
        ...
        all_seeds = [seeds["global"], seeds["master_coherence"]] + list(
            seeds["shots"].values()
        )
...
class TestConfigurationValidation:
    ...
    def test_valid_configuration_passes(
        self, manager, basic_prompt, basic_capabilities
    ):
    ...
    def test_invalid_aspect_ratio_fails(
        self, manager, basic_prompt, basic_capabilities
    ):
    ...
    def test_invalid_resolution_format_fails(
        self, manager, basic_prompt, basic_capabilities
    ):
    ...
    def test_invalid_quality_tier_fails(
        self, manager, basic_prompt, basic_capabilities
    ):
    ...
    def test_missing_generation_parameter_fails(
        self, manager, basic_prompt, basic_capabilities
    ):
    ...
    def test_mismatched_distribution_length_fails(
        self, manager, basic_prompt, basic_capabilities
    ):
    ...
    def test_negative_shot_duration_fails(
        self, manager, basic_prompt, basic_capabilities
    ):
