...
def sample_world_config():
    ...
    return WorldConfig(
        ...
        color_palette=ColorPalette(
            primary="gray", secondary="blue", accent="red", background="black"
        ),
        ...
        key_locations=[
            Location(
                ...
                visual_description="Moody",
            )
        ],
    )


def test_plan_sequences_basic(
    sequence_planner,
...
def test_each_sequence_has_shots(
    sequence_planner,
    sample_parsed_prompt,
    sample_story_structure,
    sample_dialogue_script,
...
def test_shots_have_required_fields(
    sequence_planner,
    sample_parsed_prompt,
    sample_story_structure,
    sample_dialogue_script,
...
def test_shot_numbers_sequential(
    sequence_planner,
    sample_parsed_prompt,
    sample_story_structure,
    sample_dialogue_script,
...
def test_prompt_modules_complete(
    sequence_planner,
    sample_parsed_prompt,
    sample_story_structure,
    sample_dialogue_script,
...
def test_sequence_durations_match_acts(
    sequence_planner,
    sample_parsed_prompt,
    sample_story_structure,
    sample_dialogue_script,
...
def test_sequences_have_visual_direction(
    sequence_planner,
    sample_parsed_prompt,
    sample_story_structure,
    sample_dialogue_script,
...
def test_shot_descriptions_meaningful(
    sequence_planner,
    sample_parsed_prompt,
    sample_story_structure,
    sample_dialogue_script,
...
def test_first_shot_is_establishing(
    sequence_planner,
    sample_parsed_prompt,
    sample_story_structure,
    sample_dialogue_script,
    ...
    for sequence in plan.sequences:
        ...
        assert (
            "establishing" in first_shot.description.lower()
            or first_shot.camera_angle == "high angle"
        )


def test_shot_count_appropriate_for_duration(
    sequence_planner,
    sample_parsed_prompt,
    sample_story_structure,
    sample_dialogue_script,
