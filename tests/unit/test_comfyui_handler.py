...
class TestComfyUIHandler(unittest.TestCase):
    ...
    def test_start_service_success(self, mock_engine_class):
        ...
        args = argparse.Namespace(
            comfyui_command="start", comfyui_url="http://127.0.0.1:8188", open=False
        )
    ...
    def test_stop_service_success(self, mock_engine_class):
        ...
        # Create args
        args = argparse.Namespace(
            comfyui_command="stop", comfyui_url="http://127.0.0.1:8188", open=False
        )
    ...
    def test_status_command(self, mock_engine_class):
        ...
        # Create args
        args = argparse.Namespace(
            comfyui_command="status", comfyui_url="http://127.0.0.1:8188", open=False
        )
    ...
    def test_restart_service_success(self, mock_engine_class, mock_time):
        ...
        # Create args
        args = argparse.Namespace(
            comfyui_command="restart", comfyui_url="http://127.0.0.1:8188", open=False
        )
    ...
    def test_execute_no_command(self):
        ...
        # Create args
        args = argparse.Namespace(
            comfyui_command=None, comfyui_url="http://127.0.0.1:8188", open=False
        )
