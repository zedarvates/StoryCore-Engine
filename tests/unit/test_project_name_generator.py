...
def sample_parsed_prompt():
    ...
    return ParsedPrompt(
        ...
        characters=[
            CharacterInfo(
                name="Snow White", role="protagonist", description="Cybernetic princess"
            )
        ],
...
class TestDuplicateDetection:
    ...
    def test_name_exists_returns_true_for_existing_name(
        self, generator, temp_projects_dir
    ):
    ...
    def test_generate_unique_name_for_duplicate(
        self, generator, temp_projects_dir, sample_parsed_prompt
    ):
    ...
    def test_find_unique_name_with_existing_variants(
        self, generator, temp_projects_dir
    ):
...
class TestCollisionHandling:
    ...
    def test_collision_with_existing_version_like_suffix(
        self, generator, temp_projects_dir
    ):
    ...
    def test_multiple_collisions_from_same_prompt(
        self, generator, temp_projects_dir, sample_parsed_prompt
    ):
...
class TestPathSanitizationWithCollisions:
    ...
    def test_collision_with_special_characters_removed(
        self, generator, temp_projects_dir
    ):
    ...
    def test_collision_with_whitespace_normalization(
        self, generator, temp_projects_dir
    ):
...
class TestEdgeCases:
    ...
    def test_projects_directory_created_if_not_exists(self, temp_projects_dir):
        ...
        ProjectNameGenerator(str(new_dir))
