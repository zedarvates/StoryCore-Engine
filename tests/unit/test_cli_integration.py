...
from src.grid_format_optimization.cli_integration import (
    GridFormatOptimizationCLI,
    extend_storycore_cli,
    optimize_project_format,
)
...
class TestGridFormatOptimizationCLI:
    ...
    def test_analyze_content_command(self):
        ...
        args = argparse.Namespace(project=str(self.project_path), detailed=True)
    ...
    def test_apply_recommendation(self):
        ...
        assert updated_project["format_optimization"]["enabled"]
