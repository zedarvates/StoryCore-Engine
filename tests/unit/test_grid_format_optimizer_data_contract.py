...
class TestGridFormatOptimizerDataContract:
    ...
    def test_preferences_from_data_contract(self):
        ...
        if "format_optimization" in self.project_data:
            ...
            preferences = FormatPreferences(
                ...
                minimum_quality_threshold=prefs_data.get(
                    "minimum_quality_threshold", 75.0
                ),
            ...
            assert (
                ...
                >= preferences.minimum_quality_threshold / 100.0
                or recommendation.recommended_format == GridFormat.SQUARE_3X3
            )  # Fallback
    ...
    def test_project_metadata_update(self):
        ...
        assert (
            saved_project["format_optimization"]["results"]["recommended_format"]
    ...
    def test_capability_detection(self):
        ...
        recommendation_disabled = self.optimizer.get_optimal_format(
            content_analysis_disabled
        )
    ...
    def test_backward_compatibility(self):
        ...
        minimal_project = {
            ...
            "storyboard": {
                "shots": [{"shot_id": "shot_01", "description": "Basic scene"}]
            },
        }
    ...
    def test_validation_with_data_contract(self):
        ...
        for format_spec in ["3x3", "1x2", "1x3", "1x4"]:
            ...
            assert validation.is_valid, (
                f"Format {format_spec} devrait être compatible avec Data Contract v1"
            )
    ...
    def test_performance_history_persistence(self):
        ...
        for i in range(3):
            ...
            self.optimizer.get_optimal_format(content_analysis)
    ...
    def test_error_handling_with_data_contract(self):
        ...
        malformed_project = {"invalid_field": "invalid_value"}
        ...
        partial_project = {"project_name": "partial_test", "storyboard": {"shots": []}}
