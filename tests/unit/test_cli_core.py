...
class TestCLICore:
    ...
    def test_execute_command_success(
        self, mock_get_handler, mock_validate, mock_discover
    ):
        ...
        args = argparse.Namespace(
            command="test", verbose=False, quiet=False, log_level="INFO"
        )
    ...
    def test_execute_command_no_command(self, mock_validate, mock_discover):
        ...
        args = argparse.Namespace(
            command=None, verbose=False, quiet=False, log_level="INFO"
        )
        exit_code = cli.execute_command(args)
    ...
    def test_execute_command_unknown(
        self, mock_list, mock_get_handler, mock_validate, mock_discover
    ):
        ...
        args = argparse.Namespace(
            command="unknown", verbose=False, quiet=False, log_level="INFO"
        )
        cli.setup_logging(args)
    ...
    def test_execute_command_with_error(
        ...
        args = argparse.Namespace(
            command="fail", verbose=False, quiet=False, log_level="INFO"
        )
        exit_code = cli.execute_command(args)
