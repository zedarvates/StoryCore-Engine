...
class TestRequirementValidation:
    ...
    def test_requirement_4_1_docs_directory_with_subdirectories(
    ...
    def test_requirement_5_1_tests_directory_with_subdirectories(
        self, temp_project_root
    ):
        """
    ...
    def test_requirement_8_1_assets_directory_with_subdirectories(
        self, temp_project_root
    ):
        """
