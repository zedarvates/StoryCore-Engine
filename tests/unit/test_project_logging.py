...
class TestProjectLogging:
    ...
    def test_logging_on_successful_initialization(self, tmp_path, caplog):
        ...
        assert any(
            "Creating assets directory structure" in msg for msg in log_messages
        ...
        assert any(
            "Project initialization completed successfully" in msg
...
class TestFileCreationLogging:
    ...
    def test_project_json_creation_logging(self, tmp_path, caplog):
        ...
        assert any(
            "project.json created successfully" in msg for msg in log_messages
    ...
    def test_storyboard_json_creation_logging(self, tmp_path, caplog):
        ...
        assert any(
            "storyboard.json created successfully" in msg for msg in log_messages
