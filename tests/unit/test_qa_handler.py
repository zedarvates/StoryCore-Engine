...
class TestQAHandler:
    ...
    def test_setup_parser(self):
        ...
        args = parser.parse_args(
            ["--project", "test-proj", "--threshold", "4.0", "--detailed"]
        )
    ...
    def test_execute_success_passed(self, tmp_path):
        ...
        args = argparse.Namespace(
            project=str(project_path), threshold=3.0, detailed=False
        )

        mock_report = {
            "overall_score": 4.5,
            "categories": {"sharpness": 4.5, "color_balance": 4.3, "composition": 4.7},
            "issues": [],
        }
    ...
    def test_execute_success_failed(self, tmp_path):
        ...
        args = argparse.Namespace(
            project=str(project_path), threshold=4.0, detailed=False
        )

        mock_report = {
            "overall_score": 2.5,
            "categories": {"sharpness": 2.0, "color_balance": 3.0, "composition": 2.5},
            "issues": [
                {
    ...
    def test_execute_project_not_found(self):
        ...
        handler = QAHandler()
        args = argparse.Namespace(
            project="/nonexistent/path", threshold=3.0, detailed=False
        )
    ...
    def test_execute_detailed_mode(self, tmp_path):
        ...
        args = argparse.Namespace(
            project=str(project_path), threshold=3.0, detailed=True
        )

        mock_report = {
            "overall_score": 4.0,
            "categories": {"sharpness": 4.0},
            "issues": [],
            "panel_scores": {"panel_01": 4.5, "panel_02": 3.8, "panel_03": 3.9},
        }
