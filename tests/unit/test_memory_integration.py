...
class TestMemoryIntegration(unittest.TestCase):
    ...
    def test_index_generated_assets_images(self):
        ...
        result = index_generated_assets(
            ...
            asset_type="image",
            generation_context={"workflow": "test_workflow", "shot_id": "shot_001"},
        )
    ...
    def test_index_generated_assets_audio(self):
        ...
        result = index_generated_assets(
            ...
            asset_type="audio",
            generation_context={"audio_type": "dialogue", "voice": "narrator"},
        )
    ...
    def test_index_generated_assets_video(self):
        ...
        result = index_generated_assets(
            ...
            asset_type="video",
            generation_context={"fps": 24, "duration": 5.0},
        )
    ...
    def test_index_generated_assets_empty_list(self):
        ...
        result = index_generated_assets(
            project_path=self.project_path, asset_paths=[], asset_type="image"
        )
    ...
    def test_index_generated_assets_mixed_existence(self):
        ...
        result = index_generated_assets(
            project_path=self.project_path,
            asset_paths=[str(real_file), str(self.project_path / "fake.png")],
            asset_type="image",
        )
