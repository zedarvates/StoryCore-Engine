...
class TestDataModelsSetup:
    ...
    def test_conversation_creation(self):
        ...
        message = Message(role="user", content="Test message", timestamp=datetime.now())

        conversation = Conversation(
            messages=[message], session_id="test_session", start_time=datetime.now()
        )
...
class TestSchemasSetup:
    ...
    def test_validate_schema_function(self):
        ...
        # Valid data
        valid_data = {"schema_version": "1.0", "errors": []}
