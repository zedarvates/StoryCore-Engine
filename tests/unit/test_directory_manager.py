...
def test_validate_structure_missing_directory(
    temp_dir, director_manager, sample_config
):
...
def test_validate_structure_missing_subdirectory(
    temp_dir, director_manager, sample_config
):
...
def test_get_directory_tree_contains_key_directories(
    temp_dir, director_manager, sample_config
):
...
def test_initialize_files_preserves_existing_content(
    temp_dir, director_manager, sample_config
):
