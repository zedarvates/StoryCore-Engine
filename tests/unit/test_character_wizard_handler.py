...
class TestCharacterWizardHandler:
    ...
    def test_execute_success(self, tmp_path):
        ...
        args = argparse.Namespace(
            project=str(project_path), resume=None, batch=None, genre=None, style=None
        )

        with patch(
            "character_wizard.CharacterWizardOrchestrator"
            ...
            mock_result.character_profile.quality_score = (
                4.5  # Numeric value for formatting
            )
