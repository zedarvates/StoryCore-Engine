...
class TestProjectErrorHandling:
    ...
    def test_cleanup_on_validation_failure(
        self, project_manager, temp_base, monkeypatch
    ):
        ...
        assert not project_path.exists(), (
            "Project directory should be cleaned up after validation failure"
        )
...
class TestProjectCleanup:
    ...
    def test_cleanup_prevents_non_project_deletion(self, project_manager, temp_base):
        ...
        assert non_project_path.exists(), (
            "Cleanup should not remove non-project directories"
        )
...
class TestErrorMessages:
    ...
    def test_validation_error_lists_missing_items(
        self, project_manager, temp_base, monkeypatch
    ):
