...
class TestExportHandler:
    ...
    def test_execute_success(self, tmp_path):
        ...
        args = argparse.Namespace(
            project=str(project_path), output=None, format="zip", include_source=False
        )
    ...
    def test_execute_project_not_found(self):
        ...
        handler = ExportHandler()
        args = argparse.Namespace(
            project="/nonexistent/path", output=None, format="zip", include_source=False
        )
    ...
    def test_execute_different_formats(self, tmp_path):
        ...
        for fmt in formats:
            args = argparse.Namespace(
                project=str(project_path), output=None, format=fmt, include_source=False
            )
    ...
    def test_execute_with_source_files(self, tmp_path):
        ...
        args = argparse.Namespace(
            project=str(project_path), output=None, format="zip", include_source=True
        )
