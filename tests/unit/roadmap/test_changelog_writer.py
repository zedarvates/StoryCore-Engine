...
class TestChangelogEntry:
    ...
    def test_entry_initialization(self, sample_feature):
        ...
        entry = ChangelogEntry(
            feature=sample_feature, completion_date=completion_date, version="v1.2.0"
        )
    ...
    def test_entry_without_version(self, sample_feature):
        ...
        completion_date = datetime(2026, 1, 15)
        entry = ChangelogEntry(feature=sample_feature, completion_date=completion_date)
...
class TestChangelogWriter:
    ...
    def test_format_entry_anchor_generation(self):
        ...
        assert (
            "[View in Roadmap](ROADMAP.md#test-feature-with-spaces--special)"
            in formatted
        )
    ...
    def test_organize_by_month_without_version(self, sample_feature, sample_feature_2):
        """Test organizing entries by month when no version provided."""
        writer = ChangelogWriter()
        writer.append_entry(
            feature=sample_feature, completion_date=datetime(2026, 1, 15)
        )
        writer.append_entry(
            feature=sample_feature_2, completion_date=datetime(2025, 12, 10)
        )
