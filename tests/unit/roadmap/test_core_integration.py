...
""")
    ...
    def test_complete_workflow(self, temp_specs_dir):
        ...
        assert (
            sorted_features[2].name == "documentation-update"
    ...
    def test_workflow_with_dates(self, temp_specs_dir):
        ...
        assert (
            timeline_groups["Future Considerations"][0].name == "documentation-update"
        )
    ...
    def test_metadata_override(self, temp_specs_dir):
        ...
        ui_spec = next(s for s in spec_files_list if s.directory.name == "ui-dashboard")
