...
"""
    ...
    def test_inject_badge_with_frontmatter(
        self, injector, temp_dir, sample_spec_with_frontmatter
    ):
...
"""
    ...
    def test_remove_badge_no_badge_present(
        self, injector, temp_dir, sample_spec_content
    ):
...
"""
    ...
    def test_find_insertion_point_with_frontmatter(
        self, injector, sample_spec_with_frontmatter
    ):
    ...
    def test_badge_format_uses_anchor_tag(
        self, injector, temp_dir, sample_spec_content
    ):
