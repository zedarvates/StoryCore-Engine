...
from src.roadmap.models import FeatureStatus, Priority
...
class TestConfigLoader:
    ...
    def test_load_default_config(self):
        ...
        config = ConfigLoader.load_config(config_path=Path("/nonexistent/config.yaml"))
    ...
    def test_merge_nested_configs(self):
        ...
        base = {
            ...
            "status_emoji": {"completed": "✅", "in-progress": "🚧"},
        }
    ...
    def test_config_precedence(self):
        ...
        try:
            ...
            cli_overrides = {"output_path": "cli/ROADMAP.md"}
            config = ConfigLoader.load_config(
                config_path=config_path, cli_overrides=cli_overrides
            )
